package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_735:Number = 64;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         x_scale = 1;
         y_scale = 1;
         var_1488 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_407 != param1 * var_1488)
         {
            var_407 = param1 * var_1488;
            ++var_76;
         }
      }
      ...
      {
         if(var_408 != param1 * var_1487)
         {
            var_408 = param1 * var_1487;
            ++var_76;
         }
      }
      ...
      {
         if(var_406 != param1 * var_1486)
         {
            var_406 = param1 * var_1486;
            ++var_76;
         }
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         if(_loc3_ < var_2338 || _loc3_ > var_2337)
         {
            return null;
         }
      ...
      {
         return new Vector3d(0 * var_408,0 * var_406,0 * var_407);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_408,0 * var_406,0 * var_407);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_86;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_408,param2.y * var_406,param2.z * var_407);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_408,param3.y * var_406,param3.z * var_407);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_408,param4.y * var_406,param4.z * var_407);
