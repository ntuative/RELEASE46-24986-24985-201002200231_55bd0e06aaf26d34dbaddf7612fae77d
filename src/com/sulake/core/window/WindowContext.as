package com.sulake.core.window
{
   ...
   public class WindowContext implements IWindowContext, IDisposable, IUpdateReceiver
   {
      ...
      public static const const_1449:int = 3;
      
      public static const const_1324:int = 4;
       
      
      protected var var_2254:IWindowFactory;
      
      private var _disposed:Boolean = false;
      
      private var var_638:WindowController;
      
      private var var_661:Date;
      
      protected var var_2255:IWindowParser;
      ...
      protected var var_1097:SubstituteParentController;
      
      private var var_2280:Point;
      ...
      public function WindowContext(param1:String, param2:IWindowRenderer, param3:IWindowFactory, param4:ICoreLocalizationManager, param5:DisplayObjectContainer, param6:Rectangle, param7:IWindowContextStateListener)
      {
         ...
         var_2254 = param3;
         var_2255 = new WindowParser(this);
         var_661 = new Date();
         if(var_952 == null)
         {
            var_952 = new Factory();
         ...
         var_1097 = new SubstituteParentController(this);
         var_352 = param7;
      }
      ...
      public function destroy(param1:IWindow) : Boolean
      {
         ...
         if(param1.state != WindowState.const_371)
         {
            param1.destroy();
         }
         return true;
      ...
      public function create(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:Rectangle, param7:Function, param8:IWindow, param9:uint, param10:Array = null, param11:Array = null) : IWindow
      {
         ...
         if(_loc12_ == null)
         {
            handleError(WindowContext.const_1324,new Error("Failed to solve implementation for window \"" + param1 + "\"!"));
            return null;
         }
         if(param8 == null)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         while(true)
         {
            ...
            if(_loc2_.stageX != var_535.x || _loc2_.stageY != var_535.y)
            {
               var_535.x = _loc2_.stageX;
               var_535.y = _loc2_.stageY;
               _loc5_ = new Array();
               var_89.groupChildrenUnderPoint(var_535,_loc5_);
            }
      ...
      public function getMouseCursor() : IMouseCursor
      {
         if(var_1582 == null)
         {
            var_1582 = new MouseCursorControl(var_314);
         }
         return var_1582;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_356))
         {
