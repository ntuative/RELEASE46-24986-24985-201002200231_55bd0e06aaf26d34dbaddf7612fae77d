package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1208:uint = 0;
      ...
      protected var var_611:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(!var_14)
         {
            var_14 = getGraphicContext(!testParamFlag(WindowParam.const_31));
         }
      ...
      public static function method_4(param1:WindowController, param2:IWindow) : void
      {
         var _loc9_:Boolean = false;
         var _loc10_:int = 0;
         var _loc11_:* = 0;
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_102,WindowParam.const_146);
         var _loc2_:* = !testParamFlag(WindowParam.const_106,WindowParam.const_132);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_5.clone();
            if(_loc1_)
            {
               ...
               if(_loc5_ == WindowParam.const_234)
               {
                  _loc3_.width += _loc4_;
               }
      ...
      {
         var_744 = param1;
         var_613 = !!var_744 ? uint(var_613 | var_1370) : uint(var_613 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1823 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_807:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_290:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_905:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1302:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_974:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_242:
               _loc2_ = "null";
               break;
      ...
      {
         var_427 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_5,WindowRedrawFlag.const_785);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_986 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_329,this,param1));
         return param1;
      }
      ...
      {
         return !testParamFlag(WindowParam.const_31) || var_14 != null;
      }
            ...
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  if(testParamFlag(WindowParam.const_319))
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_216))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_216))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_189:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_470,this,null));
                     if(testParamFlag(WindowParam.const_155,WindowParam.const_146))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_166,WindowParam.const_132))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_6 != null)
                  ...
                  break;
               case WindowNotifyEvent.const_421:
                  _context.invalidate(this,var_5.union(var_54),WindowRedrawFlag.const_422);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_974,this,null));
                     if(var_6 != null)
                     {
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_242,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_290:
                  if(param1 == this)
                  {
                     ...
                     if(var_6 != null)
                     {
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_195,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_455:
                  _context.invalidate(this,var_5,WindowRedrawFlag.const_952);
                  break;
               case WindowNotifyEvent.const_459:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_351:
                  if(!(var_16 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_5,WindowRedrawFlag.const_422);
                     }
                  }
                  else if(var_16 & 0)
                  {
               ...
               case WindowNotifyEvent.const_329:
                  ...
                  {
                     method_4(this,WindowNotifyEvent(param2).related);
                  }
                  break;
               case WindowNotifyEvent.const_242:
                  if(testParamFlag(WindowParam.const_62))
      ...
      {
         return var_611 != null ? var_611 : (var_6 != null ? var_6.procedure : nullEventProc);
      }
      ...
      public function maximize() : Boolean
      {
         ...
         setStateFlag(WindowState.const_61,true);
         _loc1_.type = WindowNotifyEvent.const_784;
         update(this,_loc1_);
         return true;
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_290;
         update(this,_loc1_);
         return true;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_653,this,param1));
         return param1;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_732;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_986 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_444)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_478)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_924,this,null,true);
               update(this,_loc10_);
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1165,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_61,false);
         _loc1_.type = WindowNotifyEvent.const_1211;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_6 != param1)
         {
            ...
            if(var_6 != null)
            {
               ...
               var_54.width = var_5.width;
               var_54.height = var_5.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_385,this,var_6));
            }
            else
            {
               var_296.x = 0;
               ...
               var_296.width = 0;
               var_296.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_806,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_81,var_16,_context,var_5,null,var_611,properties,var_612.concat(),_id) as WindowController;
         ...
         _loc2_.var_1370 = var_1370;
         _loc2_.var_1099 = var_1099;
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_814,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_375;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         if(var_33 == WindowState.const_371)
         {
            return true;
         }
         var_33 = WindowState.const_371;
