package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1517:String = "_INCLUDE";
      
      public static const const_816:String = "_EXCLUDE";
      
      public static const const_1527:String = "_TEMP";
      
      private static const const_1029:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1030:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1095:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_922:Dictionary;
      
      protected var var_1359:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1360:Dictionary;
      
      protected var var_1094:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1094,var_1095);
         var_922 = new Dictionary();
         var_1360 = new Dictionary();
         ParamCodeTable.fillTables(var_922,var_1360);
         var_1359 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1030,"");
         return param1.replace(const_1029,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1094)
            {
               delete var_1094[_loc1_];
            }
            for(_loc1_ in var_1095)
            {
               delete var_1095[_loc1_];
            }
            for(_loc1_ in var_922)
            {
               delete var_922[_loc1_];
            }
            for(_loc1_ in var_1360)
            {
               delete var_1360[_loc1_];
            }
            var_1359.dispose();
            var_1359 = null;
            _context = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_816) == -1)
                  {
