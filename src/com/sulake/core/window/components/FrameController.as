package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1051:String = "_HEADER";
      
      private static const const_749:String = "margin_right";
      
      private static const const_1050:String = "_SCALER";
      
      private static const const_1052:String = "_TITLE";
      
      private static const const_1049:String = "_CONTENT";
      
      private static const const_748:String = "margin_left";
      
      private static const const_750:String = "margin_bottom";
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_748,_loc3_.left,PropertyStruct.const_60,_loc2_));
         _loc1_.push(new PropertyStruct(const_747,_loc3_.top,PropertyStruct.const_60,_loc2_));
         _loc1_.push(new PropertyStruct(const_749,0 - _loc3_.right,PropertyStruct.const_60,_loc2_));
         _loc1_.push(new PropertyStruct(const_750,0 - _loc3_.bottom,PropertyStruct.const_60,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_193);
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1185 == null)
         {
            var_1185 = findChildByTag(const_1051) as IHeaderWindow;
            if(!var_1185)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1052) as ITextWindow;
            if(!_title)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_245,false);
         }
      ...
      {
         return content != null && var_1369 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1049) as IWindowContainer;
            if(!var_20)
            {
