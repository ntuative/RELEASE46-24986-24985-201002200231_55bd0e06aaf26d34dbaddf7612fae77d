package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1087:String = "content";
      
      private static const const_1088:String = "selector";
       
      
      private var var_1155:Boolean = false;
      
      protected var var_926:ITabSelectorWindow;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1587 == null)
         {
            var_1587 = findChildByTag(TabContextController.const_1087) as IWindowContainer;
         }
         return var_1587;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_926 == null)
         {
            var_926 = findChildByTag(TabContextController.const_1088) as ITabSelectorWindow;
            if(var_926 != null)
            {
               var_926.procedure = method_10;
            }
         }
         return var_926;
      }
      ...
      {
         return !!var_783 ? selector.iterator : null;
      }
