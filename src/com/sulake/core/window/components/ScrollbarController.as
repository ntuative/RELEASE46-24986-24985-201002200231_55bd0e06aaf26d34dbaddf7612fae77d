package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1125:String = "increment";
      
      private static const const_497:String = "slider_bar";
      
      private static const const_1126:String = "decrement";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_159 = false;
         var_21 = param12;
         _horizontal = param2 == WindowType.const_384;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_497:
               if(param2.type == WindowNotifyEvent.const_242)
               {
                  if(!var_604)
                  {
                     if(_horizontal)
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_910 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_910 != null)
         {
            _loc1_ = findParentByName(var_910) as IScrollableWindow;
            if(_loc1_ == null && var_6 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_6).findChildByName(var_910) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1125)
            {
               if(var_21)
               {
                  var_604 = true;
            ...
            else if(param2.name == ScrollbarController.const_1126)
            {
               if(var_21)
               {
                  var_604 = true;
         ...
         if(param1.type == WindowMouseEvent.const_801)
         {
