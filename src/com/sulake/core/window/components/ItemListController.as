package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1387:Boolean = true;
      
      protected static const const_1019:String = "auto_arrange_items";
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_159 = var_744 || !testParamFlag(WindowParam.const_31);
         _container = _context.create("_CONTAINER","",WindowType.const_317,WindowStyle.const_318,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
      ...
      {
         return new Rectangle(var_526 * maxScrollH,var_524 * maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            var_526 = param1;
            _container.x = -var_526 * maxScrollH;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1021,_spacing,PropertyStruct.const_60,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1019,var_746,PropertyStruct.const_55,var_746 != const_1387));
         _loc1_.push(new PropertyStruct(const_1022,var_525,PropertyStruct.const_55,var_525 != const_1386));
         _loc1_.push(new PropertyStruct(const_1020,var_1104,PropertyStruct.const_55,var_1104 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1020:
                  ...
                  break;
               case const_1019:
                  var_746 = _loc2_.value as Boolean;
                  break;
            }
         }
