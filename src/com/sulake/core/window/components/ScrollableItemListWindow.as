package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_828:IItemListWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_343)
         {
            ...
            if(var_343)
            {
               ...
               var_343.addEventListener(WindowEvent.const_221,scrollBarEventProc);
            }
         }
         return var_343;
      }
      ...
      override public function dispose() : void
      {
         if(var_343)
         {
            ...
            var_343.removeEventListener(WindowEvent.const_221,scrollBarEventProc);
            var_343 = null;
         }
         if(var_828)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_828)
         {
            var_828 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_828;
      }
