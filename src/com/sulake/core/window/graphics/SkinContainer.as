package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1028:uint = 8;
      ...
      private var var_1634:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1634 = new Dictionary();
         TypeCodeTable.fillTables(var_1393,var_1634);
         var_1127 = new Dictionary();
         var_1635 = new Dictionary();
         StateCodeTable.fillTables(var_1127,var_1635);
         var_443 = new Dictionary();
         var_443["skin"] = BitmapSkinRenderer;
         var_443["bitmap"] = BitmapDataRenderer;
         var_443["fill"] = FillSkinRenderer;
         var_443["text"] = TextSkinRenderer;
         var_443["shape"] = ShapeSkinRenderer;
         var_443["unknown"] = SkinRenderer;
         var_443["HabboWindowManagerCom_habbo_skin_button_checkbox_xml"] = NullSkinRenderer;
         if(var_365 == null)
         {
            var_365 = new Array();
            var_365.push(WindowState.const_61);
            var_365.push(WindowState.const_68);
            var_365.push(WindowState.const_87);
            var_365.push(WindowState.const_45);
            var_365.push(WindowState.const_75);
            var_365.push(WindowState.const_71);
            var_365.push(WindowState.const_92);
            var_365.push(WindowState.const_83);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1127)
         {
            _loc3_.push(var_1127[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1393[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_531[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_531[param1] = new Array(SkinContainer.const_1028);
         }
         var_531[param1][param2] = param3;
      }
      ...
      {
         var _loc1_:* = null;
         for(_loc1_ in var_531)
         {
            ISkinRenderer(var_531[_loc1_]).dispose();
            delete var_531[_loc1_];
         }
