package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1378:Rectangle;
      ...
      private var var_284:Rectangle;
      
      private var var_1379:Point;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_527 = new Array();
         var_1379 = new Point();
         var_1378 = new Rectangle();
         var_284 = new Rectangle();
         var_285 = new Dictionary(true);
         var_668 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_285[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc1_ = var_527.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = getWindowRendererItem(_loc1_);
               var_284.x = _loc3_.dirty.x;
               var_284.y = _loc3_.dirty.y;
               var_284.width = _loc3_.dirty.width;
               var_284.height = _loc3_.dirty.height;
               renderWindowBranch(_loc1_,_loc3_,var_284);
            }
            _loc4_++;
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1379,var_1378))
            {
               if(param2.render(param1,var_1379,var_1378))
               {
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            var_284.x = param2.x - param1.x;
            var_284.y = param2.y - param1.y;
            var_284.width = param2.width;
            var_284.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_31))
            {
               while(param1.testParamFlag(WindowParam.const_31))
               {
                  ...
                  var_284.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            getWindowRendererItem(param1).invalidate(param1,var_284,WindowRedrawFlag.const_269);
            if(var_527.indexOf(param1) == -1)
            {
               var_527.push(param1);
            }
         }
