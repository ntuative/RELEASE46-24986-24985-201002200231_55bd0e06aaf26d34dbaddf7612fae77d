package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_422:
               ...
               break;
            case WindowRedrawFlag.const_952:
               var_667 = var_668.getTheActualState(param1.type,param1.style,param1.state);
               if(var_667 != var_995)
               {
                  var_223 = true;
                  _loc4_ = true;
               ...
               break;
            case WindowRedrawFlag.const_785:
               if(param1.testParamFlag(WindowParam.const_31))
               {
                  var_223 = true;
                  _loc4_ = true;
      ...
      {
         return var_668.getTheActualState(param1.type,param1.style,param1.state) != var_995;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc10_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_752) : uint(const_491);
         var _loc6_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc6_ != null)
         {
            _loc5_ = !!_loc6_.isStateDrawable(var_667) ? uint(const_751) : uint(_loc5_);
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_751)
               {
                  ...
                  if(var_223)
                  {
                     ...
                     _loc6_.draw(param1,var_93,var_93.rect,var_667,false);
                  ...
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_31))
                  {
                     ...
                     _loc4_.draw(var_93,var_931,_colorTransform,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      private function resolveSkinRenderer(param1:IWindow) : ISkinRenderer
      {
         ...
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_989)
            {
               _loc2_ = var_668.getSkinRendererByType(param1.type,WindowStyle.const_989);
            }
         }
         return _loc2_;
      }
