package com.sulake.core.runtime
{
   ...
   public class ComponentContext extends Component implements IContext
   {
      ...
      {
         param1.removeEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,method_8,false);
         param1.removeEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR,method_8,false);
         var _loc2_:int = 0;
      ...
      {
         var _loc4_:* = null;
         var _loc3_:ComponentInterfaceQueue = this.include(param1);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            if(_loc4_ == null)
            {
               error("Interface " + param1 + " still unavailabe!",true,Core.const_1352);
            }
      ...
      public final function loadFromFile(param1:URLRequest, param2:LoaderContext) : LibraryLoader
      {
         ...
         _loc4_.addEventListener(LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE,method_8,false);
      ...
      protected final function include(param1:IID) : ComponentInterfaceQueue
      {
         var _loc3_:* = null;
      ...
      protected final function method_8(param1:LibraryLoaderEvent) : void
      {
      ...
      protected function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         removeLibraryLoader(_loc2_);
         error("Failed to download component resource \"" + _loc2_.url + "\"!" + "\r" + _loc3_,true,Core.const_1233);
      }
