package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1383:int = 5;
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_327 = this.getDefinition(_name) as Class;
         if(var_327 == null)
         {
         ...
         try
         {
            xmlClass = var_327.manifest as Class;
            if(xmlClass == null)
            {
               return;
            }
         ...
         var_454 = new XML(bytes.readUTFBytes(bytes.length));
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         switch(param1.type)
         {
            case Event.INIT:
               ...
               var_435 |= LibraryLoader.STATE_EVENT_INIT;
               break;
            case Event.COMPLETE:
               debug("Load event COMPLETE for file \"" + var_15.contentLoaderInfo.url + "\"");
               var_435 |= LibraryLoader.STATE_EVENT_COMPLETE;
               break;
         ...
         if(var_435 == LibraryLoader.STATE_ANALYZE)
         {
            if(analyzeLibrary())
            {
               var_435 |= LibraryLoader.STATE_EVENT_FRAME;
            }
         }
         if(var_435 == LibraryLoader.STATE_READY)
         {
            var_1369 = true;
            prepareLibrary();
            removeEventListeners();
      ...
      protected function handleHttpStatus(param1:int) : Boolean
      {
         if(param1 >= 400)
         {
            if(var_925 > 0)
            {
               var_15.close();
               var_15.unload();
               addRequestCounterToUrlRequest(var_315,const_1383 - var_925);
