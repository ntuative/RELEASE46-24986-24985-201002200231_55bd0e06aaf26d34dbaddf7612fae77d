package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_964:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_542:uint = 0;
      
      public static const const_815:String = "AssetLibraryReady";
      
      public static const const_1284:String = "AssetLibraryUnloaded";
      
      public static const const_477:String = "AssetLibraryLoaded";
      
      public static const const_1268:String = "AssetLibraryLoadError";
       
      
      private var var_454:XML;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         var_386 = new Dictionary(false);
         var_645 = new Dictionary(false);
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_386)
         {
            _loc2_ = var_386[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_386[_loc1_];
         }
         for(_loc1_ in _loadedAssets)
         {
            delete _loadedAssets[_loc1_];
         }
         for(_loc1_ in var_645)
         {
         ...
         var_290 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1284));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_454 = _loc2_.manifest.copy();
         var_327 = _loc2_.resource;
         if(var_453)
         {
            AssetLibrary.fetchLibraryContents(this,var_454,var_327);
         }
         var_290 = true;
         dispatchEvent(new Event(AssetLibrary.const_477));
         dispatchEvent(new Event(AssetLibrary.const_815));
         if(var_453)
         {
            var_15.dispose();
            var_15 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_386[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_846,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_797,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_833,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_386[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_964.splice(var_964.indexOf(this),1);
            --var_542;
            var_386 = null;
            var_645 = null;
            _loadedAssets = null;
      ...
      {
         return param1 < var_326.length ? getAssetByName(var_326[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1268));
      }
      ...
      {
         var _loc2_:Class = var_645[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_454.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_327[param1]);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_386[loader.url];
         if(struct == null)
         {
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_326.splice(var_326.indexOf(_loc2_),1);
      ...
      {
         return var_327 != null ? false : false;
      }
   }
}
