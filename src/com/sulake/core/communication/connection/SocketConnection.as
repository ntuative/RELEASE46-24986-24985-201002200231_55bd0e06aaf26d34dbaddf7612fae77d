package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1365:int = 10000;
      ...
      private var var_721:IEncryption;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         var_80 = new Socket();
         var_354 = new Timer(const_1365,1);
         var_354.addEventListener(TimerEvent.TIMER,onTimeOutTimer);
      ...
      {
         var_354.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - var_722));
      ...
      {
         var_354.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - var_722));
      ...
      {
         var_354.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - var_722));
         dispatchEvent(param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         if(var_721 != null)
         {
            _loc3_ = var_721.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      {
         var_299.addConnectionMessageEvent(_id,param1);
      }
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(false)
         {
            var_353.writeByte(var_80.readUnsignedByte());
         }
      }
      ...
      {
         var_354.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - var_722));
         dispatchEvent(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var _loc2_:uint = var_588.getMessages(var_353,_loc1_);
         ...
         for each(_loc4_ in _loc1_)
         {
            ...
            {
               _loc13_ = var_299.getMessageEvents(this,_loc9_);
            ...
            for each(_loc12_ in _loc8_)
            {
               ...
               if(_loc14_ != null)
               {
                  ...
                  if(_loc14_ != _loc11_)
                  {
                     ...
                     _loc10_ = var_299.getMessageParser(_loc14_);
                     if(_loc10_.flush())
                     {
         ...
         else if(_loc2_ > 0)
         {
            ...
            _loc18_.writeBytes(var_353,_loc2_);
            var_353 = _loc18_;
         }
      }
      ...
      {
         var_354.delay = param1;
      }
      
      private function onIOError(param1:IOErrorEvent) : void
      {
         var_354.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - var_722));
         switch(param1.type)
         {
      ...
      {
         var_354.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - var_722));
         dispatchEvent(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_721 + "\n");
      }
   }
}
