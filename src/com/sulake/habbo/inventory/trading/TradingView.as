package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      public static const const_897:int = 2;
      
      private static const const_765:uint = 4284532064;
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_992)
            {
            ...
            var_351.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_463);
            var_351.show();
         }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1522 == null)
         {
            var_1522 = createMinimizedWindow();
         }
         if(!var_2100)
         {
            return var_63;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_63)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_765) : uint(const_764);
            }
