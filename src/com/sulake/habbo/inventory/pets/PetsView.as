package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      private function selectFirst() : void
      {
         ...
         setSelectedGridItem(var_605.getWithIndex(0));
      }
      ...
      {
         var _loc2_:PetsGridItem = var_605.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_605.getValue(param1.id) != null)
         {
            return;
         }
