package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private const const_1598:int = 8947848;
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_48:
               var_944.setSelectedGridItem(this);
               var_758 = true;
               break;
            ...
            case WindowMouseEvent.const_27:
               ...
               {
                  var_758 = false;
                  var_944.placePetToRoom(var_1187.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         _window.color = !!_isSelected ? uint(const_1598) : uint(const_1599);
      }
