package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(var_658 == InventoryCategory.const_172)
            {
               toggleCategoryView(InventoryCategory.const_172);
            }
            else if(var_658 == InventoryCategory.const_72)
            {
      ...
      public function setHabboToolbarIcon() : void
      {
         if(var_195 != null)
         {
            var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_119,HabboToolbarIconEnum.INVENTORY));
         }
      }
      ...
      private function setSubViewToCategory(param1:String) : void
      {
         ...
         if(var_195 != null)
         {
            var_195.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_561,HabboToolbarIconEnum.INVENTORY,var_12 as IWindowContainer));
         }
      }
      ...
      public function showInventory() : void
      {
         ...
         var_11.inventoryViewOpened(var_659);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true) : void
      {
         ...
         else
         {
            _loc3_.visible = true;
            _loc3_.activate();
            if(param1 != var_658 || !var_11.isInventoryCategoryInit(param1))
            {
               setViewToCategory(param1);
            }
            if(var_195 != null && var_794)
