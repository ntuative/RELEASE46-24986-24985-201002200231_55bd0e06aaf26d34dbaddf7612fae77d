package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_899:IRoomSession;
      ...
      {
         return effectsModel.method_1(1);
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_17 != null)
         {
            ...
            var_17.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_441,roomSessionEventHandler);
      ...
      {
         return EffectsModel(var_46.getValue(InventoryCategory.const_499));
      }
      ...
      {
         return PetsModel(var_46.getValue(InventoryCategory.const_172));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_835));
      }
      ...
      {
         return AchievementsModel(var_46.getValue(InventoryCategory.const_302));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_240:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_898.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_898.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_46.getValue(InventorySubCategory.const_240));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_338 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_898.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_46.getValue(InventoryCategory.const_378) as MarketplaceModel;
      }
      ...
      {
         return BadgesModel(var_46.getValue(InventoryCategory.const_229));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_17.events.addEventListener(RoomSessionPropertyUpdateEvent.const_441,roomSessionEventHandler);
         ...
         var_46.add(InventoryCategory.const_378,_loc3_);
         ...
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_338);
         var_46.add(InventoryCategory.const_229,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_46.add(InventoryCategory.const_499,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_338);
         var_46.add(InventoryCategory.const_302,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_46.add(InventorySubCategory.const_240,_loc8_);
         ...
         var_46.add(InventoryCategory.const_172,_loc10_);
