package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      {
         return var_451.removeGridItemAt(param1);
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_48)
         {
            ...
            _model.toggleItemSelection(_category,var_451.getGridItemIndex(param1.window));
            var_323 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_27 && var_323 != null && var_323 == param2 && true)
         {
