package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1413,var_1412);
         }
      }
      ...
      {
         if(param1 != var_1709 || param2 != var_1713)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_1712);
      }
      ...
      {
         if(var_11 != null && false && var_213 != null)
         {
            var_11.furniModel.removeLockFrom(var_213.id);
            var_213 = null;
         }
      }
