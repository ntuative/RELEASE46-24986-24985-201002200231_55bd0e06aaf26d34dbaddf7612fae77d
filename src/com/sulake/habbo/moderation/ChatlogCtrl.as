package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1421:IMessageComposer;
      ...
      {
         var_867 = IWindowContainer(var_47.getXmlWindow("chatlog_roomheader"));
         var_866 = IWindowContainer(var_47.getXmlWindow("chatlog_chatline"));
         ...
         var_47.connection.send(var_1421);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_867.clone());
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_866.clone());
         _loc4_.color = var_1300[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
