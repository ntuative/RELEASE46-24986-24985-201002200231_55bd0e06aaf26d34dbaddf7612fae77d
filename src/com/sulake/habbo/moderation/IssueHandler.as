package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_56.issueManager.releaseBundle(var_112.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_391 = new UserInfoCtrl(_window,var_56,_loc3_.message);
         ...
         if(false)
         {
            var_968.load(_loc4_,var_112.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_56.issueManager.method_7(var_112.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_56.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_56,WindowTracker.const_893,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_56 != null && false && var_112 != null)
         {
            var_56.issueManager.removeHandler(var_112.id);
         }
         this.dispose();
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_56.issueManager.method_7(var_112.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_56.issueManager.method_7(var_112.id,3);
         checkAutoHandling();
         dispose();
      }
