package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_654:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_47.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),var_47,WindowTracker.const_578,_data.flatId),var_50,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_654.isSelected);
         var_47.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1251,_loc2_,var_398.text,"",""));
         if(false)
         {
            var_47.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_983.isSelected,var_982.isSelected,var_654.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1275);
         }
      ...
      public function populate() : void
      {
         ...
         var_654 = ICheckBoxWindow(var_50.findChildByName("kick_check"));
         var_983 = ICheckBoxWindow(var_50.findChildByName("lock_check"));
         var_982 = ICheckBoxWindow(var_50.findChildByName("changename_check"));
