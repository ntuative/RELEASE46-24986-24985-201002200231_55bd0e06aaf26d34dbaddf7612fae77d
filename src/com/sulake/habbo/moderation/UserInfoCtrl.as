package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_771:int = 86400;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_771) + " days ago";
         }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_47.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_47,WindowTracker.const_847,_data.userId),_callerFrame,var_1063,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_876.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(var_47.getXmlWindow("user_info"));
            var_876.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_47.windowTracker.show(new ModActionCtrl(var_47,_data.userId,_data.userName,var_1214),_callerFrame,var_1063,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_47.windowTracker.show(new RoomVisitsCtrl(var_47,_data.userId),_callerFrame,var_1063,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_47.windowTracker.show(new SendMsgsCtrl(var_47,_data.userId,_data.userName,var_1214),_callerFrame,var_1063,false,true);
      }
