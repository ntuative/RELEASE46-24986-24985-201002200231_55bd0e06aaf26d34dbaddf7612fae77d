package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private var var_2359:BitmapData;
      
      private var var_2360:BitmapData;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         var_49 = param3;
         var_1247 = param4;
         var_1451 = var_571.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         for each(_loc5_ in param1)
         {
            ...
            if(_loc5_ == null || var_1451 == null)
            {
               return;
            }
            _loc2_ = var_1451.clone() as IWindowContainer;
            if(_loc2_ == null)
            {
               return;
            }
