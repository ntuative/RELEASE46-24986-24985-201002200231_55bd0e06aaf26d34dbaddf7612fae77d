package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1610:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1612:String = "picked_issues";
      ...
      private var var_1496:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_346.view.width = var_230.container.width;
         var_346.view.height = var_230.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1611:
               if(var_1497 == null)
               {
                  var_1497 = new MyIssuesView(issueManager,this,var_230.container);
               }
               return var_1497;
            case const_1610:
               if(var_1498 == null)
               {
                  var_1498 = new OpenIssuesView(issueManager,this,var_230.container);
               }
               return var_1498;
            case const_1612:
               if(var_1496 == null)
               {
                  var_1496 = new PickedIssuesView(issueManager,this,var_230.container);
               }
               return var_1496;
            default:
               return null;
