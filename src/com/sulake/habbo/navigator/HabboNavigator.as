package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2355:Dictionary;
      ...
      private var var_767:ISessionDataManager;
      
      private var var_766:RoomCreateViewCtrl;
      
      private var var_1646:RoomThumbnailRenderer;
      
      private var var_195:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_536:RoomInfoViewCtrl;
      
      private var _catalog:IHabboCatalog;
      
      private var var_420:Tabs;
      
      private var var_247:MainViewCtrl;
      
      private var var_1718:Array;
      
      private var var_1011:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_247 = new MainViewCtrl(this);
         var_536 = new RoomInfoViewCtrl(this);
         var_766 = new RoomCreateViewCtrl(this);
         var_1646 = new RoomThumbnailRenderer(this);
         var_1011 = new GuestRoomPasswordInput(this);
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_247.startSearch(Tabs.const_191,Tabs.const_307,param1);
         var_247.mainWindow.activate();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_767)
         {
            var_767.release(new IIDSessionDataManager());
            var_767 = null;
         }
         if(_catalog)
         {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_163.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_195 != null)
         {
            var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_119,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_119,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_767 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_247.startSearch(Tabs.const_228,Tabs.const_192);
         var_420.getTab(Tabs.const_228).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_247.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
