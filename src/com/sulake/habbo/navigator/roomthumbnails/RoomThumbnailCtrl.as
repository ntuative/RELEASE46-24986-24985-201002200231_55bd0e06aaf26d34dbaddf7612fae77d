package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1463,this._model.mode != ThumbnailEditorModel.const_52);
         setEnabled(var_1464,this._model.mode != ThumbnailEditorModel.const_32);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1463 = IButtonWindow(find("top_tab"));
         var_1464 = IButtonWindow(find("obj_tab"));
         var_1874 = IWindowContainer(find("tile_grid"));
         var_1873 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1463,onTopTabButton);
         Util.setProcDirectly(var_1464,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1874;
         _loc1_.visible = true;
      ...
      {
         var _loc1_:IWindowContainer = var_1873;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_54,HabboWindowStyle.const_36,HabboWindowParam.const_65,new Rectangle(0,0,param1.width,66)));
