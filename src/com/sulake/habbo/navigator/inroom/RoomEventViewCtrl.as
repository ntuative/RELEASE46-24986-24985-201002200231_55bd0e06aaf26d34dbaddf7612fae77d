package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_2139:IButtonWindow;
      
      private var var_1311:IButtonWindow;
      ...
      private var var_879:IDropMenuWindow;
      ...
      private function onEditButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = var_719.getText();
         var _loc6_:Array = new Array();
         addTag(_loc6_,var_880.getText());
         addTag(_loc6_,var_881.getText());
      ...
      {
         var_879.visible = false;
         var_1533.visible = true;
         var_2140.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_719.setText(param1.eventDescription);
         var_880.setText(getTagFromEvent(param1,1));
         var_881.setText(getTagFromEvent(param1,2));
         var_1311.visible = false;
         var_1309.visible = true;
         var_1310.visible = true;
         var_1535.visible = false;
         var_1534.visible = true;
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1533 = IWindowContainer(find("event_type_disabled_cont"));
            var_2140 = ITextWindow(find("event_type_disabled_text"));
            var_1535 = ITextWindow(find("create_caption"));
            var_1534 = ITextWindow(find("edit_caption"));
            var_1311 = IButtonWindow(find("create_button"));
            var_1309 = IButtonWindow(find("edit_button"));
            var_2139 = IButtonWindow(find("cancel_button"));
            var_1310 = IButtonWindow(find("end_button"));
            var_879 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1311,onCreateButtonClick);
            Util.setProcDirectly(var_1309,onEditButtonClick);
            Util.setProcDirectly(var_1310,onEndButtonClick);
            Util.setProcDirectly(var_2139,onCancelButtonClick);
            _eventNameInput = new TextFieldManager(_navigator,getInput("event_name"),25);
            var_719 = new TextFieldManager(_navigator,getInput("event_desc"),100);
            var_880 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
            var_881 = new TextFieldManager(_navigator,getInput("event_tag_2"),25);
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!var_719.checkMandatory(_navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
      ...
      private function createEvent() : void
      {
         ...
         var_719.goBackToInitialState();
         _eventNameInput.goBackToInitialState();
         var_880.goBackToInitialState();
         var_881.goBackToInitialState();
         var_879.selection = 0;
         var_1535.visible = true;
         var_1534.visible = false;
      }
   }
}
