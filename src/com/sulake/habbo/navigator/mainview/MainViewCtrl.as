package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      private static const const_1031:int = 4;
      
      private static const SCROLLBAR_WIDTH:int = 22;
      
      public static const const_454:int = 1;
      
      private static const const_739:int = 3;
      ...
      private var var_1140:IRegionWindow;
      
      private var var_378:int;
      
      private var var_1143:Boolean = true;
      
      private var var_636:GuestRoomListCtrl;
      ...
      private var var_1142:IWindow;
      
      private var var_1141:Boolean;
      
      private var var_760:OfficialRoomListCtrl;
      
      private var var_20:IWindowContainer;
      
      private var var_635:PopularTagsListCtrl;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_635 = new PopularTagsListCtrl(_navigator);
         var_636 = new GuestRoomListCtrl(_navigator);
         var_760 = new OfficialRoomListCtrl(_navigator);
      ...
      private function prepare() : void
      {
         ...
         var_230 = ITabContextWindow(var_12.findChildByName("tab_context"));
         var_20 = IWindowContainer(var_12.findChildByName("tab_content"));
         var_212 = IWindowContainer(var_12.findChildByName("custom_content"));
         var_183 = IWindowContainer(var_12.findChildByName("list_content"));
         var_244 = IWindowContainer(var_12.findChildByName("custom_footer"));
         var_1142 = var_12.findChildByName("loading_text");
         var _loc1_:IWindow = var_12.findChildByTag("close");
         _loc1_.procedure = onWindowClose;
         var_1140 = IRegionWindow(var_12.findChildByName("to_hotel_view"));
         var_1140.procedure = onHotelView;
         ...
         var_12.scaler.setParamFlag(HabboWindowParam.const_1317,true);
      }
      ...
      private function method_2(param1:Boolean, param2:Boolean, param3:IViewCtrl, param4:String) : void
      {
         var _loc5_:* = null;
         if(!param2)
         {
      ...
      private function refreshListContent(param1:Boolean) : void
      {
         ...
         method_9(param1,_navigator.data.popularTagsArrived);
         refreshOfficialRooms(param1,_navigator.data.officialRoomsArrived);
      }
      
      private function onResizeTimer(param1:TimerEvent) : void
      {
         refreshScrollbar(var_635);
         refreshScrollbar(var_636);
      }
      ...
      {
         Util.hideChildren(var_212);
         var _loc1_:Tab = _navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshCustomContent(var_212);
         if(Util.hasVisibleChildren(var_212))
         {
      ...
      {
         method_2(param1,param2,var_760,"official_rooms");
      }
      
      private function refreshGuestRooms(param1:Boolean, param2:Boolean) : void
      {
         method_2(param1,param2,var_636,"guest_rooms");
      }
      ...
      private function method_9(param1:Boolean, param2:Boolean) : void
      {
         method_2(param1,param2,var_635,"popular_tags");
      }
      ...
      private function refreshFooter() : void
      {
         ...
         var _loc1_:Tab = _navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshFooter(var_244);
      ...
      public function refresh() : void
      {
         ...
         refreshFooter();
         var_212.height = Util.getLowestPoint(var_212);
         var_244.height = Util.getLowestPoint(var_244);
         var _loc1_:int = 0;
         Util.moveChildrenToColumn(var_20,["custom_content","list_content"],var_212.y,8);
         var_183.height = var_183.height + _loc1_ - 0 - 0 + var_1689;
         Util.moveChildrenToColumn(var_20,["list_content","custom_footer"],var_183.y,8);
         var_1689 = var_244.height;
         onResizeTimer(null);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_378 == const_740)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_183.blend - _loc2_));
            this.var_183.blend = _loc3_;
            this.var_212.blend = !!var_1143 ? Number(_loc3_) : Number(1);
            this.var_244.blend = !!var_1143 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               var_378 = const_484;
            }
      ...
      {
         _navigator.refreshButton(var_1140,"icon_hotelview",!param1,null,0);
         _navigator.refreshButton(var_1140,"icon_hotelview_reactive",param1,null,0);
      }
