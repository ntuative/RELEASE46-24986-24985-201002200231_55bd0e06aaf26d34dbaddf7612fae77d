package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1244:ICheckBoxWindow;
      ...
      private var var_1011:TextFieldManager;
      ...
      private function populateForm() : void
      {
         ...
         {
            case RoomSettingsData.const_157:
         ...
         setTag(var_880,_loc1_.tags[0]);
         setTag(var_881,_loc1_.tags[1]);
         if(var_1241)
         {
            if(_loc1_.allowPets)
            {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow(param1,"",HabboWindowType.const_54,HabboWindowStyle.const_36,HabboWindowParam.const_65,new Rectangle(0,0,100,20)));
      }
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1477.visible = _inRoom;
         var_1478.visible = _inRoom;
         var_1926.visible = var_483;
         var_1927.visible = !var_483;
         if(var_483)
         {
         ...
         else
         {
            ...
            var_1245.visible = _inRoom;
            _navigator.thumbRenderer.refreshThumbnail(IWindowContainer(var_1245.findChildByName("picframe")),_navigator.data.enteredGuestRoom.thumbnail,false);
            var_1009.height = Util.getLowestPoint(this.var_1009) + 4;
         }
         var_1475.text = !!var_483 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1477.name,var_1245.name,var_1009.name,var_1010.name,var_1243.name,var_1478.name],0,0);
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "doormode_doorbell":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_157;
               break;
            case "doormode_password":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_127;
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_394;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_127)
         {
            _loc8_ = var_1011.getText();
            _loc9_ = var_1242.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1011.clearErrors();
               this.var_1242.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowFoodConsume = var_1240.isSelected;
         _loc2_.allowWalkThrough = var_1244.isSelected;
         _loc2_.tags = new Array();
         addTag(var_880,_loc2_.tags);
      ...
      {
         if(param1 != this.var_404 || var_1008 < 1)
         {
            return;
         }
         close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         {
            setTagError(this.var_880,param3,"${navigator.roomsettings.unacceptablewords}");
         ...
         {
            setTagError(this.var_880,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         ...
         {
            this.var_1011.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_529,onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_793,onDoorModePasswordUnselect);
         ...
         this.var_880 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         this.var_881 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag2")),30);
         this.var_1011 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password")),30);
         this.var_1242 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password_confirm")),30);
         this.var_1241 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         this.var_1240 = ICheckBoxWindow(_window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1244 = ICheckBoxWindow(_window.findChildByName("allow_walk_through_checkbox"));
         var_1477 = IWindowContainer(_window.findChildByName("header_container"));
         var_1245 = IWindowContainer(_window.findChildByName("thumbnail_container"));
         var_1009 = IWindowContainer(_window.findChildByName("basic_settings_container"));
         var_1010 = IWindowContainer(_window.findChildByName("advanced_settings_container"));
         var_1478 = IWindowContainer(_window.findChildByName("switch_view_container"));
         ...
         var_1012 = IWindowContainer(_window.findChildByName("password_container"));
         var_1927 = ITextWindow(_window.findChildByName("basic_caption"));
         var_1926 = ITextWindow(_window.findChildByName("advanced_caption"));
