package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_856:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_501 = new Timer(100);
         var_501.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_62 = new Array();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var_2048 = _navigator.data.hcMember;
      }
      ...
      public function dispose() : void
      {
         if(var_501)
         {
            var_501.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_501.reset();
            var_501 = null;
         }
      }
      ...
      private function refresh() : void
      {
         ...
         var_856 = var_62[0];
         if(var_2048 != _navigator.data.hcMember)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_54,HabboWindowStyle.const_36,HabboWindowParam.const_65,new Rectangle(0,0,100,300)));
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_856.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1283 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1283 = true;
            _loc3_.y = 1;
