package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private static var var_1439:uint = 13232628;
      
      private static var var_1810:uint = 11129827;
      ...
      public function setNameAvailableView() : void
      {
         ...
         var_47.localization.registerParameter("help.tutorial.name.available","name",var_394);
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "button_usecurrent":
                  var_394 = var_47.help.ownUserName;
                  showConfirmationView(true);
                  break;
               case "button_name_check":
                  if(_loc3_.text.length < 1)
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            var_47.localization.registerParameter("help.tutorial.name.confirmation","name",var_394);
         }
         if(var_253 == null)
         {
            var_253 = var_47.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_253 == null)
            {
               return;
            }
