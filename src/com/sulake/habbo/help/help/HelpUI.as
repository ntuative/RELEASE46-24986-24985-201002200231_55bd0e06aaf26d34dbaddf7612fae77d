package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2191:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","24986-24985-201002200149");
         var_195 = param5;
         var_106 = new Map();
         var_106.add(HabboHelpViewEnum.const_1231,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_133,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_469,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_247,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_218,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_648,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_320,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_600,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_220,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_106.add(HabboHelpViewEnum.const_956,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_106.add(HabboHelpViewEnum.const_652,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_276 == HabboHelpViewEnum.const_133 || false)
         {
            return;
         }
         if(var_429 == null)
      ...
      {
         return var_106.getValue(var_276);
      }
      ...
      {
         var_2189 = param1;
         var _loc2_:IHelpViewController = var_106.getValue(HabboHelpViewEnum.const_133) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_220:
               ...
               break;
            case CallForHelpResultEnum.const_936:
               showUI(HabboHelpViewEnum.const_956);
               break;
            case CallForHelpResultEnum.const_965:
      ...
      {
         var _loc3_:* = null;
         if(var_276 == HabboHelpViewEnum.const_133)
         {
            return;
         }
         if(true)
         {
            ...
            var_596.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_596[1],var_596[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_596[0],var_596[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1552;
         _window.width = _loc1_.width + var_1553;
      }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_29.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_577));
      }
