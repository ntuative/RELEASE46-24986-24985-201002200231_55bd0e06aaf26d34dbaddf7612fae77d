package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1083:int = 0;
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_684 == null || _loc3_ < 0 || _loc3_ >= var_684.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_684[_loc3_];
            main.showUI(HabboHelpViewEnum.const_600);
            main.tellUI(HabboHelpViewEnum.const_600,null);
         }
      }
   }
}
