package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1690 = param2;
         var_338 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_107,onBadgeImageReady);
         ...
         var_1994 = param5.getKey("notifications.text.achievement_facebook");
      ...
      public function dispose() : void
      {
         if(var_338 != null)
         {
            var_338.events.removeEventListener(BadgeImageReadyEvent.const_107,onBadgeImageReady);
            var_338 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_690,var_1994);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_690,var_690));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_690,var_690));
         _localizations.registerParameter(param1,"level",var_1690.toString());
         _localizations.registerParameter(param1,"name",var_338.userName);
         _localizations.registerParameter(param1,"realname",var_338.realName);
      }
   }
}
