package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_521:int = 70;
      ...
      private var var_1068:uint;
      
      private var var_1321:int;
      
      private var var_885:uint;
      
      private var var_428:Map;
      
      private var var_886:uint;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar)
      {
         ...
         if(_loc7_ != null)
         {
            var_1321 = 0 - _loc7_.rectangle.bottom;
         }
         else
         {
            var_1321 = 15;
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _window.height = 0;
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + var_1321;
         if(_window.height < var_1543)
         {
            _window.height = var_1543;
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(var_33)
         {
            ...
            case const_366:
               var_885 += param1;
               _loc2_ = Number(var_885) / Number(var_428["time_fade_in"]);
               if(var_885 > int(var_428["time_fade_in"]))
               {
                  startDisplay();
               }
               adjustBlend(_loc2_);
            ...
            case const_773:
               var_1068 += param1;
               if(var_1068 > int(var_428["time_display"]) && !var_1320)
               {
                  startFadeOut();
               }
               break;
            case const_772:
               var_886 += param1;
               _loc3_ = 1 - Number(var_886) / Number(var_428["time_fade_out"]);
               adjustBlend(_loc3_);
               if(var_886 > int(var_428["time_fade_in"]))
               {
                  startIdling();
               }
         }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = var_195.orientation == "TOP" ? int(const_346) : 0;
         var _loc4_:int = var_195.orientation == "BOTTOM" ? int(_loc2_.height - const_346) : int(_loc2_.height);
         var _loc5_:int = var_195.orientation == "LEFT" ? int(const_346) : 0;
         var _loc6_:int = var_195.orientation == "RIGHT" ? int(_loc2_.width - const_346) : int(_loc2_.width);
         if(false)
         {
            if(false)
            {
               _window.x = _loc5_ + const_374;
            }
            else
            {
               _window.x = _loc6_ - 0 - const_374;
            }
         }
         else if(false)
         {
