package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_371:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_938:int = -1;
      
      private var var_1121:LagWarningLogger = null;
      
      private var var_750:IHabboWindowManager;
      ...
      private var var_162:IHabboFriendList;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1121 = new LagWarningLogger();
         var_1122 = new Array(const_738);
         var _loc4_:int = 0;
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1215,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1296,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_518,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_913,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1150);
               break;
            case HabboCommunicationEvent.const_659:
               trackLoginStep(HabboLoginTrackingStep.const_1225,String(_communication.port));
               break;
            case HabboCommunicationEvent.const_185:
               trackLoginStep(HabboLoginTrackingStep.const_185);
               break;
            case HabboCommunicationEvent.const_159:
               trackLoginStep(HabboLoginTrackingStep.const_159);
               break;
            ...
            case HabboCommunicationEvent.const_187:
               ...
               trackLoginStep(HabboLoginTrackingStep.const_187);
               if(var_211 != null)
               {
                  var_211.init();
               }
      ...
      {
         var_163 = IHabboConfigurationManager(param2);
         if(var_163)
         {
            Component(var_163).events.addEventListener(HabboConfigurationEvent.const_164,onConfigurationLoaded);
            if(var_211 != null)
            {
               var_211.configuration = var_163;
            }
            if(var_210 != null)
            {
               var_210.configuration = var_163;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _adManager.events.addEventListener(AdEvent.const_370,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_913,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_518,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_659,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_185,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_168,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_159,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_187,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_649,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_63,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_431,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_462:
               var_1121.registerWarning(LagWarningLogger.const_838);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_750)
            {
               var_750.release(new IIDHabboWindowManager());
               var_750 = null;
            }
            if(_adManager)
            {
            ...
            if(var_162)
            {
               if(true)
               {
                  Component(var_162).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
                  Component(var_162).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
                  Component(var_162).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
                  Component(var_162).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
                  Component(var_162).events.removeEventListener(HabboFriendListTrackingEvent.const_324,onFriendlistTrackingEvent);
               }
               var_162.release(new IIDHabboFriendList());
               var_162 = null;
            }
            if(var_371)
            {
               if(true)
               {
                  var_371.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,method_6);
                  var_371.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,method_6);
               }
               var_371.release(new IIDHabboHelp());
               var_371 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_462,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_163)
         {
            Component(var_163).events.removeEventListener(HabboConfigurationEvent.const_164,onConfigurationLoaded);
         }
      }
      ...
      {
         var_371 = param2 as IHabboHelp;
         var_371.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,method_6);
         var_371.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,method_6);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_786);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_786,onCoreRunning);
         }
      }
      ...
      {
         var_750 = IHabboWindowManager(param2);
         if(var_750)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_938 > -1 && _loc2_ < var_938)
         {
            ++var_1386;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1386);
         }
         if(var_938 > -1 && _loc2_ - var_938 > 15000)
         {
            ++var_1385;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1385);
         }
         var_938 = _loc2_;
         if(var_210 != null)
         {
         ...
         if(var_1121 != null)
         {
            var_1121.update(param1);
         }
      }
      
      public function trackLoginStep(param1:String, param2:String = null) : void
      {
         if(var_163 != null && Boolean(var_163.getKey("processlog.enabled") == false))
         {
            return;
         }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_462,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_243,onRoomAdClick);
      }
      ...
      {
         var_162 = param2 as IHabboFriendList;
         Component(var_162).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
         Component(var_162).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
         Component(var_162).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
         Component(var_162).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
         Component(var_162).events.addEventListener(HabboFriendListTrackingEvent.const_324,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_163)
            {
               if(var_163.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = var_163.getKey("client.fatal.error.url");
