package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_798:String = "group_badge";
       
      
      private const const_1411:String = "badge_";
      ...
      private function onBadgeImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_.assetLoader != null && _loc2_.assetLoader.content != null)
            {
               ...
               _loc4_ = _loc2_.assetName.replace(const_1411,"");
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc3_:String = const_1411 + param1;
         ...
         switch(param2)
         {
            case const_1357:
               if(var_163 != null)
               {
                  _loc5_ = var_163.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_798:
               if(var_163 != null)
               {
                  if(var_163 != null)
                  {
                     _loc5_ = var_163.getKey("group.badge.url");
