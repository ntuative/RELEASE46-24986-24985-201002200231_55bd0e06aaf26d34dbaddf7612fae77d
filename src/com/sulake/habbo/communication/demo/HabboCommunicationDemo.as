package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1956:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_98:IHabboConfigurationManager;
      
      private var var_1491:ILogger;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         if(var_1015)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_159);
         }
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_332:
               _loc3_ = var_98.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_932:
               _loc3_ = var_98.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_984:
               _loc3_ = var_98.getKey("logout.url");
               break;
            case DisconnectReasonEvent.const_792:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1955)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_687 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_687);
            _loc2_.send(_loc4_);
      ...
      {
         var_1015 = true;
         dispatchLoginStepEvent(HabboCommunicationEvent.const_185);
         param1.send(new VersionCheckMessageComposer(401,var_1254,var_1957));
         var _loc2_:String = "";
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_485.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_485.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1956);
      ...
      {
         var_687 = var_98.getKey("sso.ticket",null);
         var_1254 = var_98.getKey("flash.client.url","");
         var_1957 = var_98.getKey("external.variables.txt","");
         if(var_169 == null)
         {
         ...
         if(var_687 != null)
         {
            var_72.mode = HabboConnectionType.const_481;
            var_72.initConnection(HabboConnectionType.const_236);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1491 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_659);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1956 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_72.mode)
         {
            case HabboConnectionType.const_481:
               ...
               var_1014 = _loc4_;
               var_169.loadBannerImage(_loc7_ + "?token=" + var_1014,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1288:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1282:
               var_1016 = generateRandomHexString(30);
               var_485 = new DiffieHellman(new BigInteger(var_98.getKey("connection.development.prime"),16),new BigInteger(var_98.getKey("connection.development.generator"),16));
               var_485.init(var_1016);
               _loc8_ = var_485.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1014);
         ...
         var_485 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_1016 = generateRandomHexString(30);
            var_485.init(var_1016);
            _loc12_ = var_485.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         dispatchLoginStepEvent(HabboCommunicationEvent.const_187);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(var_98).events.addEventListener(HabboConfigurationEvent.const_164,onConfigurationLoaded);
         }
      }
