package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1266:uint = 1;
      
      public static const const_1178:uint = 2;
       
      
      private var var_803:IProtocolDecoder;
      
      private var var_996:IProtocolEncoder;
      
      public function WedgieProtocol()
      {
         super();
         var_996 = new WedgieEncoder();
         var_803 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1266)
            {
               _loc4_.position = 0;
               _loc6_ = var_803.getID(_loc4_);
