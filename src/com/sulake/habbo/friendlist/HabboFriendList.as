package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1405:OpenedToWebPopup;
      
      private var var_762:IAvatarRenderManager;
      
      private var var_195:IHabboToolbar;
      
      private var var_420:FriendListTabs;
      ...
      private var var_1404:AvatarSearchResults;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_761:FriendRequests;
      
      private var var_1694:int;
      
      var var_13:FriendCategories;
      
      private var var_1693:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_763:IHabboNotifications;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1693 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_13 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1404 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_761.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_761.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_420.findTab(FriendListTab.const_84).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_761 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_13.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_13.addCategory(new FriendCategory(FriendCategory.const_928,getText("friendlist.friends")));
         var_13.addCategory(new FriendCategory(FriendCategory.const_390,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_13.addFriend(new Friend(_loc4_));
         }
         var_420 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_446)
         {
            var_446 = new Timer(120000);
            var_446.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_446.start();
         }
         getBuddyRequests();
         registerListeners();
         var_195.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_119,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_446.stop();
            var_446.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_446 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_762)
         {
            var_762.release(new IIDAvatarRenderManager());
            var_762 = null;
         }
         if(var_763)
         {
            var_763.release(new IIDHabboNotifications());
            var_763 = null;
         }
         if(var_195)
         {
      ...
      {
         var _loc1_:String = var_163.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_420.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1404.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_761.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      {
         var _loc2_:FriendListTab = var_420.findTab(FriendListTab.const_84);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_762.createAvatarImage(param1,AvatarScaleType.const_96);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_761.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_420.findTab(FriendListTab.const_84);
      ...
      {
         var_763 = param2 as IHabboNotifications;
      ...
      {
         return var_163.getKey(param1,param1,param2);
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1405 == null)
         {
            var_1405 = new OpenedToWebPopup(this);
         }
         var_1405.show(x,y);
      }
