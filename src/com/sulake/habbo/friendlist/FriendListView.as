package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1416:String = "noconvinfo";
      
      private static const const_1415:String = "messageinput";
      ...
      private var var_1306:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1306 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_790 = IWindowContainer(var_12.content.findChildByName("main_content"));
         var_244 = IWindowContainer(var_12.content.findChildByName("footer"));
         var_1306.prepare(var_790);
         var_12.procedure = onWindow;
         var_12.content.setParamFlag(HabboWindowParam.const_852,false);
         var_12.content.setParamFlag(HabboWindowParam.const_1277,true);
         var_12.header.setParamFlag(HabboWindowParam.const_709,false);
         var_12.header.setParamFlag(HabboWindowParam.const_967,true);
         var_12.content.setParamFlag(HabboWindowParam.const_709,false);
         var_12.content.setParamFlag(HabboWindowParam.const_967,true);
         var_12.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1307 = ITextWindow(var_12.findChildByName("info_text"));
         var_1307.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_244.y = Util.getLowestPoint(var_12.content);
         var_244.width = _friendList.tabs.windowWidth;
         ...
         var_12.scaler.setParamFlag(HabboWindowParam.const_828,this._friendList.tabs.findSelectedTab() != null);
         var_12.scaler.setParamFlag(HabboWindowParam.const_709,false);
         var_12.scaler.setParamFlag(HabboWindowParam.const_852,false);
         var_12.scaler.x = 0 - var_12.scaler.width;
         var_12.scaler.y = 0 - var_12.scaler.height;
         var_1531 = var_12.height;
         var_1530 = var_12.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = var_1531 == -1 ? 0 : int(0 - var_1531);
         var _loc4_:int = var_1530 == -1 ? 0 : int(0 - var_1530);
