package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1504:int = "F".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         _id = param1.id;
         _name = param1.name;
         var_935 = param1.gender;
         var_703 = param1.online;
         var_1146 = param1.followingAllowed && param1.online;
         var_547 = param1.figure;
         var_1149 = param1.motto;
         var_1145 = param1.lastAccess;
         var_1148 = param1.categoryId;
         var_1147 = param1.realName;
