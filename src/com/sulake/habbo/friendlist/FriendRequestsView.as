package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1391:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_289 && _loc4_.state != FriendRequest.const_287)
            {
      ...
      {
         var_1407 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1406 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1406.procedure = onDismissAllButtonClick;
         var_1407.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_805)
         {
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_289;
