package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_755:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1004[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_1007[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1004 = new Array();
         var_1004.push(Math.random() * _loc2_ * 1.5);
         var_1004.push(Math.random() * _loc2_ * 1.5);
         var_1006 = new Array();
         var_1006.push(1);
         var_1006.push(-1);
         var_1005 = new Array();
         var_1005.push(const_1078);
         var_1005.push(const_1077);
         var_1007 = new Array();
         var_1007.push(getRandomAmplitudeFactor());
         var_1007.push(getRandomAmplitudeFactor());
      }
