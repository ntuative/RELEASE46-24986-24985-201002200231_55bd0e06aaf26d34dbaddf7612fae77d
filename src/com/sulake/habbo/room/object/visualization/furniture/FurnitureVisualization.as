package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_1457:String = null;
      ...
      protected var var_2265:Number = NaN;
      ...
      protected function updateSprites(param1:int, param2:Number) : void
      {
         ...
         var _loc4_:Boolean = false;
         if(var_1457 != null && var_1457.indexOf("http") == 0)
         {
            _loc4_ = true;
         }
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_889:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_968:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      {
         var _loc3_:int = 0;
         if(var_1905 != param1 || var_1906 != param2)
         {
      ...
      {
         var _loc3_:int = 0;
         if(var_1903 != param1 || var_1904 != param2)
         {
            _loc3_ = spriteCount - 1;
            while(_loc3_ >= 0)
            {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2270 = _loc3_.getNumber(RoomObjectVariableEnum.const_224);
            ...
            var_1457 = _loc3_.getString(RoomObjectVariableEnum.const_297);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_283 != _loc3_.getUpdateID() || param1 != var_207 || param2 != var_2265)
         {
