package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_170:BitmapData = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         super();
         var_2017 = param8;
         var_838 = new Vector3d();
         var_838.assign(param1);
         var_71 = new Vector3d();
         ...
         var_495 = Vector3d.crossProduct(var_271,var_270);
         if(false)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_254 || _type == const_181))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_837 || false && false && !var_153 || var_563 == null)
         {
            return;
         }
      ...
      {
         if(var_133 == null || var_104 == null || var_78 == null || var_105 == null || param2 == null || _bitmapData == null)
         {
            return;
         }
         ...
         if(_type == const_254 || _type == const_181)
         {
      ...
      {
         var_133.assign(param1.getScreenPosition(var_71));
         var_104.assign(param1.getScreenPosition(Vector3d.sum(var_71,var_270)));
         var_78.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(var_71,var_271),var_270)));
         var_105.assign(param1.getScreenPosition(Vector3d.sum(var_71,var_271)));
         _offset = param1.getScreenPoint(var_838);
         ...
         var _loc2_:Number = Math.min(var_133.x,var_104.x,var_78.x,var_105.x);
         var _loc3_:Number = Math.max(var_133.x,var_104.x,var_78.x,var_105.x);
         var _loc4_:Number = Math.min(var_133.y,var_104.y,var_78.y,var_105.y);
         var _loc5_:Number = Math.max(var_133.y,var_104.y,var_78.y,var_105.y);
         _loc3_ -= _loc2_;
         _offset.x = 0 - _loc2_;
         var_133.x = 0 - _loc2_;
         var_104.x = 0 - _loc2_;
      ...
      public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : Boolean
      {
         ...
         if(param3)
         {
            ...
            _loc5_ = 0;
            while(_loc5_ < var_1276.length)
            {
               _loc4_ = Number(Vector3d.cosAngle(param1.directionAxis,var_1276[_loc5_]));
               if(_loc4_ > -0.001)
               {
                  if(_isVisible)
                  {
            ...
            _loc6_ = param1.getScreenPosition(var_838);
            _loc7_ = _loc6_.z;
      ...
      public function method_15(param1:BitmapData) : BitmapData
      {
         if(_isVisible)
         {
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            if(var_694 != null)
            {
               _loc3_ = var_694.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1506,var_2019,var_2018,var_2015,var_2016,param2);
               if(_loc3_ != null)
               {
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(var_170 != null && (var_170.width != param1.width || var_170.height != param1.height))
         {
            var_170.dispose();
            var_170 = null;
         }
         if(var_170 == null)
         {
            var_170 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         var_170.copyChannel(param1,param1.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         var_170.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(var_170,var_170.rect,new Point(0,0),BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
