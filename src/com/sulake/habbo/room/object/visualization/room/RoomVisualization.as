package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1370:int = 13421772;
      
      private static const const_1111:int = 16777215;
      
      public static const const_1246:int = 10066329;
      
      private static const const_1112:int = 13421772;
      
      public static const const_1145:int = 16777215;
      ...
      public static const const_1171:int = 13421772;
      ...
      private var var_1847:int = -1000;
      
      private var var_1049:uint = 16777215;
      
      private var var_2092:Boolean = true;
      ...
      private var var_580:Rectangle = null;
      
      private var var_2093:int = 255;
      ...
      private var var_421:RoomPlaneBitmapMaskParser = null;
      
      private var var_1054:Number = 0;
      ...
      public function RoomVisualization()
      {
         ...
         var_421 = new RoomPlaneBitmapMaskParser();
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         while(_loc7_ < var_79.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_254,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_254 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_580 == null)
         {
            var_580 = super.boundingRectangle;
         }
         return new Rectangle(var_580.x,var_580.y,var_580.width,var_580.height);
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_421.maskCount)
         {
            _loc6_ = var_421.getMaskType(_loc5_);
            _loc7_ = var_421.getMaskLocation(_loc5_);
            _loc8_ = var_421.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_102.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_254 || _loc3_.type == RoomPlane.const_181 && _loc8_ == RoomPlaneBitmapMaskData.const_209)
                  {
            ...
            if(_loc12_ != null)
            {
               if(_loc12_.update(param1,_loc5_,param2))
               {
                  if(_loc12_.visible)
                  {
                     ...
                     _loc16_ = _loc12_.method_15(_loc15_);
                     if(_loc16_ == null)
                     {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1520;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1299)
         {
            var_1299 = param1.updateId;
            var_580 = null;
            _loc9_ = param1.direction;
            if(_loc9_ != null && (_loc9_.x != var_1054 || _loc9_.y != var_2087 || _loc9_.z != var_2086 || param1.scale != var_2088))
            {
               var_1054 = _loc9_.x;
               var_2087 = _loc9_.y;
               var_2086 = _loc9_.z;
               var_2088 = param1.scale;
               _loc4_ = true;
            }
         }
         ...
         {
            _loc10_ = _loc6_.getString(RoomObjectVariableEnum.const_819);
            if(_loc10_ != var_2094)
            {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_678));
            if(_loc11_ != var_1049)
            {
               var_1049 = _loc11_;
               var_2090 = var_1049 & 255;
               var_2093 = var_1049 >> 8 & 255;
               var_2091 = var_1049 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1847 + const_1619 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1847 = _loc7_;
         if(var_161 != _loc6_.getUpdateID())
         {
            _loc12_ = _loc6_.getString(RoomObjectVariableEnum.const_608);
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_548);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_677);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_2092 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_921));
            var_161 = _loc6_.getUpdateID();
         }
         updatePlanes(param1,_loc4_,param2);
         var _loc8_:int = 0;
         while(_loc8_ < var_422.length)
         {
            _loc15_ = 0;
            _loc16_ = getSprite(_loc15_);
            _loc17_ = var_422[_loc8_] as RoomPlane;
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_181)
            {
               if(var_2092)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_2090 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_2093 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_2091 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_102.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_254 && param2 != null)
               {
                  _loc5_.id = param2;
               }
