package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1602:int = 1;
      ...
      private const const_1089:int = 3;
      
      private const const_1603:int = 2;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc7_:String = _loc4_.getString(RoomObjectVariableEnum.const_160);
         var _loc8_:Number = new Date().valueOf();
         var _loc9_:Boolean = false;
         var _loc10_:Number = _loc4_.getNumber(RoomObjectVariableEnum.AVATAR_TALK_TIMESTAMP);
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_696);
         ...
         var _loc14_:Number = _loc8_ - var_1259;
         ...
         var _loc16_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_313);
         if(_loc16_ > 0)
         {
         ...
         var _loc20_:Boolean = var_283 != _loc3_.getUpdateID() || var_207 != param1.scale || var_161 != _loc4_.getUpdateID();
         ...
         if(_loc20_ || _loc21_)
         {
            ...
            if(_loc6_ == null)
            {
               _loc6_ = var_775.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_314);
            if(isNaN(_loc25_) || _loc4_.getString(RoomObjectVariableEnum.const_230) == "float")
            {
               _loc25_ = _loc24_;
            }
            else
            ...
            _loc26_ = _loc4_.getString(RoomObjectVariableEnum.const_230);
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_726);
            _loc6_.appendAction(AvatarAction.const_632,_loc26_,_loc27_);
            _loc28_ = false;
            if(_loc26_ == "lay")
            {
            ...
            _loc29_ = _loc4_.getNumber(RoomObjectVariableEnum.const_362);
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_51)
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_413);
               _loc52_ = 3;
               _loc53_ = _loc8_ - _loc51_;
               if(_loc53_ < _loc52_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_322,AvatarAction.const_1376[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_874);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_796,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_937);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_979);
               _loc55_ = 5;
               _loc56_ = _loc8_ - _loc54_;
               if(_loc56_ < _loc55_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_884,_loc31_);
               }
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_720);
            _loc33_ = 0;
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_598);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_998,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_830);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_996,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_423);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_427) > 0;
            if(_loc35_ || _loc13_)
            {
               _loc6_.appendAction(AvatarAction.const_715);
            }
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_415);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_790);
            if(_loc36_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_592,_loc36_);
            }
            ...
            _loc43_ = getSprite(const_1603);
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_829))
            {
               _loc43_.visible = true;
               _loc40_ = null;
               _loc39_ = null;
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_775.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_.content as BitmapData;
            ...
            var_774.push(getTimer() - _loc23_);
            if(false)
            {
               _loc77_ = 0;
               _loc78_ = "[";
               for each(_loc79_ in var_774)
               {
                  _loc77_ += _loc79_;
                  _loc78_ += "," + _loc79_;
               }
