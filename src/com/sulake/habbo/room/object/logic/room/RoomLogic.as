   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_702:
                  _loc2_.setString(RoomObjectVariableEnum.const_548,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_721:
                  _loc2_.setString(RoomObjectVariableEnum.const_608,_loc3_.value);
                  break;
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_457:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_209)
                  {
                     _loc8_ = "null";
                  }
                  var_421.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_562:
                  _loc7_ = var_421.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_421.getXML();
               _loc10_ = _loc9_.toXMLString();
               _loc2_.setString(RoomObjectVariableEnum.const_819,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_921,int(_loc5_.bgOnly));
            var_1312 = _color;
            var_1540 = var_1158;
            var_1065 = _loc11_;
            var_1539 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_678,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1320,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1331,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1167,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_136 || _loc13_ == RoomPlaneData.const_264)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_882)
         {
            ...
            {
               _loc7_ = var_1312 >> 16 & 255;
               _loc8_ = var_1312 >> 8 & 255;
               _loc9_ = var_1312 & 255;
               _loc10_ = var_1065 >> 16 & 255;
               _loc11_ = var_1065 >> 8 & 255;
               _loc12_ = var_1065 & 255;
               _loc13_ = (_loc2_ - var_882) / var_1541;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = var_1540 + (var_1539 - var_1540) * _loc13_;
               _color = _loc3_;
               var_1158 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_678,_loc3_);
         }
      }
   }
}
