package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_741:String = "tile_cursor";
      ...
      private static const const_1032:String = const_339;
      ...
      public static const const_544:String = "RCL_LOADER_READY";
      ...
      private var var_951:IEventDispatcher = null;
      
      private var var_1144:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_447 = [];
         var_448 = [];
         var_1700 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1698 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_380 = new Map();
         _events = new Map();
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = var_534.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      {
         return [const_339,const_485,ROOM_CONTENT,const_741,const_742];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1700.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_170 && _loc5_ != RoomObjectLogicEnum.const_111)
         {
            _loc6_ = "@shadow";
      ...
      {
         var _loc2_:String = var_449.getValue(param1) as String;
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return var_533.getValue(param1);
         }
         return "";
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_381 != null)
         {
            _loc2_ = var_381.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1293);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_464,_loc5_);
         }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_241;
         }
         return RoomObjectCategoryEnum.const_194;
      }
      ...
      private function continueInitilization() : void
      {
         if(var_1699)
         {
            ...
            if(var_951 != null)
            {
               var_951.dispatchEvent(new Event(const_544));
            }
         }
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_951 = param1;
            var_1695 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1701 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1697 = param2.getKey("public.room.dynamic.download.url","");
            var_1696 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_33 = const_743;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_381 != null)
         {
            ...
            var_381.add(param1,param2);
         }
         if(var_382 != null)
         {
            var_382.remove(param2);
            var_382.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_170 && _loc5_ != RoomObjectVisualizationEnum.const_111)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_368.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(getObjectCategory(const_274 + param1) == RoomObjectCategoryEnum.const_58)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1144.getValue(param1) != null)
         {
            var_165 = var_1144.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_477,onContentLoaded);
            _loc6_ = 0;
