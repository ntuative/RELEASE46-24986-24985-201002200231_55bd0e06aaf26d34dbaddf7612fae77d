package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_906:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_370,0,0,_loc4_,var_1567,var_906,var_905));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2227 = int(_config.getKey("interstitial.interval","30000"));
         var_2226 = int(_config.getKey("interstitial.show.time","5000"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1347 = _loc2_.imageUrl;
         var_1567 = _loc2_.clickUrl;
         if(var_1347 != "" && var_1567 != "")
         {
            _loc3_ = var_1347;
            ...
            _loc4_ = new URLRequest(var_1347);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1346 = _loc2_.imageUrl;
         var_2228 = _loc2_.clickUrl;
         var_736 = getTimer();
         if(var_1346 != "")
         {
            _loc3_ = var_1346;
            ...
            var_238.start();
            _loc4_ = new URLRequest(var_1346);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_456,0,0,param1.bitmapData,var_2228));
            var_736 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_905 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1565 > 0 && var_1566 >= var_1565)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_736;
         if(_loc1_ > var_2227)
         {
            ++var_1566;
      ...
      {
         var_299 = param2 as IHabboCommunicationManager;
         if(var_299 == null)
         {
            return;
         }
         _connection = var_299.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_906 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
