package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      {
         var _loc2_:* = null;
         if(_itemList == null || param1 < 0 || param1 > _itemList.numListItems || param1 == var_688)
         {
            return;
         }
         if(var_688 != -1)
         {
            _loc2_ = _itemList.getListItemAt(var_688) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(var_688 % 2) ? uint(const_1407) : uint(const_1408);
            }
         }
