package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_175:IWidgetAvatarEffect;
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(var_869 != null)
         {
            if(false)
            {
               _loc2_ = 0 / Number(var_175.duration);
               var_869.width = _loc2_ * var_375;
            }
            else
            {
               var_869.width = 0;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_869 != null)
         {
            var_375 = var_869.width;
            var_172.start();
            onUpdate();
         }
         if(false)
         {
            setElementBitmap("effect_icon",var_175.icon);
         }
      }
