package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewAlphaSlider
   {
      ...
      {
         if(param1.type != WindowMouseEvent.const_89 && param1.type != WindowMouseEvent.const_375)
         {
            return;
         }
      ...
      {
         return int(param1 / var_1510 * (var_1034 - var_697)) + var_697;
      }
   }
}
