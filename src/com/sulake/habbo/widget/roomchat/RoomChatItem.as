package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1393:Number = 10;
      
      private static const const_1394:Number = 8;
       
      
      private var var_1167:Number;
      ...
      {
         _widget.onItemMouseOut(var_958,var_957,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_958,var_957,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1168 = param1.chatType;
         var_958 = param1.userId;
         var_773 = param1.userName;
         var_957 = param1.userCategory;
         _message = param1.text;
         var_1167 = param1.userX;
         var_186 = param1.userImage;
         var_959 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_959 != 0)
            {
               _loc30_ = uint(var_959 >> 16 & 255);
               _loc31_ = uint(var_959 >> 8 & 255);
               _loc32_ = uint(var_959 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1168 == RoomWidgetChatUpdateEvent.const_270)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_773);
            }
            else if(var_1168 == RoomWidgetChatUpdateEvent.const_249)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_773);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_340 + _loc20_.textWidth + const_486;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_958,var_957,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_958,var_957,_roomId,_roomCategory,param1);
      }
