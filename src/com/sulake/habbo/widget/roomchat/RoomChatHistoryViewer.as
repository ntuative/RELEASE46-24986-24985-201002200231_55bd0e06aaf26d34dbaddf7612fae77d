package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      public static const const_991:int = 3;
      ...
      private var var_298:Boolean = false;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_150.state = RoomChatHistoryPulldown.const_223;
         ...
         var_42 = param2.createWindow("chatscroller","",HabboWindowType.const_803,HabboWindowStyle.const_39,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      {
         return !!var_298 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_227 > 0 && param2)
         {
            if(var_1237)
            {
               if(Math.abs(param1 - var_227) <= const_991)
               {
                  return;
               }
               var_1237 = false;
      ...
      public function showHistoryViewer() : void
      {
         if(!var_298 && !var_1217)
         {
            ...
            var_150.state = RoomChatHistoryPulldown.const_330;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_150.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_223);
      }
