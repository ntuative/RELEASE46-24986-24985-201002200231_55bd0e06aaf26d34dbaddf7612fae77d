package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_629[var_937] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_286)
         {
            ...
            var_286 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_286.center();
            var_286.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_937;
         if(var_937 < var_629.length)
         {
            _loc1_ = var_629[var_937] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_629.length);
                  _loc2_.text = _loc6_;
               }
