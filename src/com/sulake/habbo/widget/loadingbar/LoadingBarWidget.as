package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_399:Sprite = null;
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         {
            var_399 = new Sprite();
            var_399.addChild(new Bitmap(_image));
            var_399.addEventListener(MouseEvent.CLICK,clickHandler);
         }
         else
         {
            _loc5_ = var_399.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = _image;
            }
         }
         _loc2_.setDisplayObject(var_399);
         _window.visible = true;
         _window.center();
      }
      ...
      private function clickHandler(param1:Event) : void
      {
         if(var_1457 != "")
         {
            HabboWebTools.openWebPage(var_1457);
         }
      }
      ...
      override public function dispose() : void
      {
         if(var_399 != null)
         {
            var_399.removeEventListener(MouseEvent.CLICK,clickHandler);
            var_399 = null;
         }
         if(_image != null)
         {
