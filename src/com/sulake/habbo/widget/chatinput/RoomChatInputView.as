package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1417:int = 5;
      
      private static const const_486:int = 16;
      
      private static const const_1116:int = 20;
      
      private static const const_340:int = 10;
      
      private static const const_1115:int = 40;
      ...
      private var var_375:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1066 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_2148 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2147 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_720 = new Timer(1000,1);
         var_720.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_883 = new Timer(5000,1);
         var_883.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowEvent.const_150,onInputChanged);
         _window.addEventListener(WindowEvent.const_425,onWindowMoved);
         var_1313 = true;
         var_139 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2146 = _loc2_.width + const_486 + _loc6_.width + const_1116;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1115,_loc8_.width) + const_486);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1066 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_139 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_375);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_375);
         }
