package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1406:int = 150;
      
      private static const const_1082:int = 3000;
      
      private static const const_1080:int = 30000;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatInputContentUpdateEvent.const_498,onChatInputUpdate);
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_208,onUserInfo);
         param1.addEventListener(RoomWidgetChatInputDisplayEvent.const_585,onSettings);
      ...
      {
         var_1250 = param1.name;
      }
      
      private function onSettings(param1:RoomWidgetChatInputDisplayEvent) : void
      {
         var_1950 = param1.allowPaste;
      }
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         switch(param1.messageType)
         {
            case RoomWidgetChatInputContentUpdateEvent.const_922:
               ...
               break;
            case RoomWidgetChatInputContentUpdateEvent.const_1138:
         }
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatInputContentUpdateEvent.const_498,onChatInputUpdate);
         param1.removeEventListener(RoomWidgetChatInputDisplayEvent.const_585,onSettings);
      ...
      private function checkForFlooding() : Boolean
      {
         ...
         if(var_410 > const_1081)
         {
            if(_loc1_ < var_1249 + const_1082)
            {
               var_824 = true;
               var_683 = const_1080 / 1000;
               Logger.log("Enabling flood blocking");
               var_825 = new Timer(1000,var_683);
      ...
      private function refreshWindowPosition() : void
      {
         ...
         var _loc1_:RoomWidgetChatInputWidgetMessage = new RoomWidgetChatInputWidgetMessage(RoomWidgetChatInputWidgetMessage.const_734,_visualization.window);
         if(messageListener != null)
         {
