package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1622:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1623:String = "level";
      
      private var var_103:IItemListWindow;
      
      private const const_1628:String = "energy";
      ...
      private const const_1621:uint = 3355443;
      
      private var var_225:IBorderWindow;
      
      private const const_1629:int = 158;
      
      private const const_1627:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_279:PetCommandTool;
      
      private const const_1626:uint = 11184810;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_225 = _window.getListItemByName("info_border") as IBorderWindow;
         if(var_225 != null)
         {
            var_103 = var_225.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         _widget.mainContainer.addChild(_window);
         var _loc3_:IWindow = var_225.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_225.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      {
         if(var_103 == null || var_225 == null || var_60 == null)
         {
            return;
         }
         ...
         var_225.height = NaN;
         _window.width = Math.max(var_225.width,var_60.width);
      ...
      private function openTrainView() : void
      {
         if(var_279 == null)
         {
            var_279 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1187.getValue(var_632) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_279.showWindow(true);
            var_279.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1623,param1.level,param1.levelMax);
         updateStateElement(const_1625,param1.experience,param1.experienceMax);
         updateStateElement(const_1628,param1.energy,param1.energyMax);
         ...
         if(var_279 && var_279.isVisible() && param1.isOwnPet)
         {
            var_279.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_279.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_414,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1629,const_1627,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1626);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1621);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1622);
         return _loc5_;
      }
