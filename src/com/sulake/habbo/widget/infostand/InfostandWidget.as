package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1401:String = "infostand_user_view";
      
      private var var_297:InfoStandPetView;
      
      private var var_1187:InfoStandPetData;
      
      private var var_127:Timer;
      
      private var var_793:InfoStandFurniView;
      ...
      private const const_1399:String = "infostand_pet_view";
      
      private const const_1400:String = "infostand_furni_view";
      
      private const const_1606:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_793 = new InfoStandFurniView(this,const_1400);
         var_194 = new InfoStandUserView(this,const_1401);
         var_297 = new InfoStandPetView(this,const_1399);
         var_336 = new InfoStandBotView(this,const_1398);
         var_367 = new InfostandUserData();
         var_417 = new InfostandFurniData();
         var_1187 = new InfoStandPetData();
         var_127 = new Timer(const_1606);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_194.setTags(param1.tags,var_1830);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_504,onFurniInfo);
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_501,onBadgeImage);
      ...
      private function onPetInfo(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         var_297.update(petData);
         selectView(const_1399);
         if(var_127)
         {
            var_127.start();
         }
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_392,var_297.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_504,onFurniInfo);
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_501,onBadgeImage);
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         var_793.update(param1);
         selectView(const_1400);
         if(var_127)
         {
            var_127.stop();
         }
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_244:
               ...
               if(var_297 != null && false && var_297.window.visible)
               {
      ...
      {
         var_297.updateEnabledTrainingCommands(param1.id,param1.enabledCommands);
      }
