package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_423:ToolbarBarMenuAnimator;
      
      private var var_1196:Array;
      
      private var var_121:Number;
      
      private var var_1817:XML;
      ...
      {
         return var_1194.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < var_1196.length)
         {
            _loc2_ = var_655.indexOf(var_1196[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = var_294[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(var_859 + _loc3_);
                  _loc3_ += var_1195;
               }
            }
            _loc4_++;
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,_windowManager,_assetLibrary,param1,_events,var_423);
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_294[var_655.indexOf(param1)];
      }
      
      public function set method_5(param1:Number) : void
      {
         var_1815 = param1;
      }
      
      public function get method_5() : Number
      {
         return var_1815;
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = var_1817.elements("menu");
         var _loc5_:int = 0;
