package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_445:String = "LEFT";
      ...
      private var var_949:Boolean = true;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_182 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_54,HabboWindowStyle.const_870,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_949 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_949)
         {
         ...
         var_1136 = _loc7_.toolbar.@margin_bottom;
         var_1401 = _loc7_.toolbar.@min_group_margin;
         var_1402 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc9_,var_532,param1,param2,var_182,var_268);
         alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_121,var_445,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         while(_loc2_ < var_243.length)
         {
            ...
            _loc6_ += _loc3_.iconCount * _loc3_.method_5;
            _loc2_++;
         }
         var _loc7_:* = 0;
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1401,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1136) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1401,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1136) / -1));
         ...
         while(_loc2_ < var_243.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = var_445;
               _loc3_.iconSize = _loc3_.method_5 * _loc9_;
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IWindowContainer, param6:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc10_ < param1.length())
         {
            ...
            _loc9_.method_5 = _loc7_.@icon_size;
            _loc9_.iconSize = _loc9_.method_5;
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_121,var_445);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_532.length)
         {
            _loc2_ = var_532[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_445);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_121,var_445);
         }
      }
