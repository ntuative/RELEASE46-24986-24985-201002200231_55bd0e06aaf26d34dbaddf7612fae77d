package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1041:Number = 90;
      
      private static const const_775:int = 50;
      
      private static const const_1039:Number = 25;
      
      private static const const_1122:int = 50;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1072 = param2;
         var_593 = new Timer(const_1039);
         var_593.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var_517.push(param2);
         param1.addEventListener(WindowEvent.const_425,windowEventListener);
      ...
      {
         return param1.x + param1.width < const_775 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_775 || param1.desktop.height - param1.y < const_1122;
      }
