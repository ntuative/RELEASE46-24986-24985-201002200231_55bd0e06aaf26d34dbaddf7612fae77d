package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1199:IScrollbarWindow;
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_409:
                  _loc4_ = var_1200.clone();
                  if(var_549 != null)
                  {
                     var_549.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_549,var_1199,var_1373);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_207:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_322,AvatarAction.const_701);
                              _loc13_.appendAction(AvatarAction.const_592,_loc6_.productClassId);
      ...
      override public function init() : void
      {
         ...
         var_1441 = new Point(var_83.x,var_83.y);
         var_549 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1199 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_549 == null)
         {
         ...
         var_1200 = _loc2_.content as BitmapData;
