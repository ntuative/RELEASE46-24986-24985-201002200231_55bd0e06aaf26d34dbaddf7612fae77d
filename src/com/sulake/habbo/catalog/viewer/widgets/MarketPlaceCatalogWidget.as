package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_857:MarketPlaceOfferData;
      
      private const const_1389:int = 1;
      
      private const const_1617:int = 40;
      ...
      private function updateList() : void
      {
         ...
         if(!var_503)
         {
            ...
            var_503 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_503)
         {
            return;
         ...
         if(!var_418)
         {
            var_418 = new Timer(25);
            var_418.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_858 = 0;
         populateList();
         var_418.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_560)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_503 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_503.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1389);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
      ...
      override public function dispose() : void
      {
         ...
         if(var_418)
         {
            var_418.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_418 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_858 >= var_560.length)
            {
               return true;
            }
            addListItem(var_560.getWithIndex(var_858));
            ++var_858;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_857.offerId);
            }
            return;
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_150)
         {
