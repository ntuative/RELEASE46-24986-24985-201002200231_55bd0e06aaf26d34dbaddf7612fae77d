package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         var_1075 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_1075 != null)
         {
            var_1075.addEventListener(WindowKeyboardEvent.const_714,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_1075.text));
      }
   }
}
