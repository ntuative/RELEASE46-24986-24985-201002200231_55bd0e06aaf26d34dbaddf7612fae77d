package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1288:IProductData;
      ...
      {
         super();
         var_1287 = param1.productType;
         var_1286 = param1.furniClassId;
         var_1044 = param1.extraParam;
         var_1045 = param1.productCount;
         var_1285 = param1.expiration;
         var_1288 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_73:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_1044);
               break;
