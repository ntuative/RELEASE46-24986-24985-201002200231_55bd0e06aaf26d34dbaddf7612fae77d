package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1601:uint = 4.291613146E9;
      ...
      private const const_1600:int = 10;
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_772;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_772,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_652,var_77,var_956);
               dispose();
               break;
            case "cancel_button":
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_772);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_539[var_184]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_540[var_185]);
         _catalog.purchaseProductAsGift(var_652,var_77,var_956,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_150:
               ...
               if(var_1723 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in var_220)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= const_1600)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_1723 = _loc3_.text;
               break;
            case WindowMouseEvent.const_48:
               showSuggestions(false);
               if(var_1165)
               ...
               break;
            case WindowKeyboardEvent.const_714:
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc6_.productType)
            {
               ...
               case ProductTypeEnum.const_207:
                  ...
                  break;
               case ProductTypeEnum.const_475:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1411 = _loc1_.stuffTypes;
            var_539 = _loc1_.boxTypes;
            var_540 = _loc1_.ribbonTypes;
            var_772 = var_1411[0];
            var_184 = var_539[0];
            var_185 = var_540[0];
            initColorGrid();
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_452 == null)
         {
            var_452 = createWindow("suggestion_list_item") as IWindowContainer;
            var_452.procedure = suggestionsEventHandler;
         }
         if(var_216 == null || var_452 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_216.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_452.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
