package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_496:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_497 != null)
         {
            ...
            {
               _loc2_ = var_497.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_497.getValue(_loc15_) as BitmapData;
      ...
      {
         return [RoomWidgetChatMessage.const_575,RoomWidgetChatSelectAvatarMessage.const_622];
      }
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_140,_container.roomSession,0,"Version 24986-24985-201002200149");
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_496 == null)
            {
               ...
               var_498.y = 0;
               var_498.z = 0;
               var_496 = _loc4_.getScreenPoint(var_498);
            ...
            var_498.y = 0;
            var_498.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_498);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_496.x || _loc8_.y != var_496.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_496,_loc5_));
