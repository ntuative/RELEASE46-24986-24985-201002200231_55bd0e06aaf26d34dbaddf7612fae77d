package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_100:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_711,_loc2_.userName));
               break;
      ...
      {
         return [RoomWidgetLetUserInMessage.const_623];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_623:
      ...
      {
         return [RoomSessionDoorbellEvent.const_100,RoomSessionDoorbellEvent.const_115,RoomSessionDoorbellEvent.const_53];
      }
