   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_821,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_713,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_419,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_713,onFigureUpdate);
         ...
         if(var_8 != null)
         {
            (var_8 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_835,onAvatarEffectsChanged);
            (var_8 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_825,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_419,onHelpTutorialEvent);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_419:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_435));
         }
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_511);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_671);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_569);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_528);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_705);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_543);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_645);
         _loc1_.push(RoomWidgetStopEffectMessage.const_525);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1373);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_993);
         _loc1_.push(RoomWidgetToolbarMessage.const_634);
         _loc1_.push(RoomWidgetToolbarMessage.const_724);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_526);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1339);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_800);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_651);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_564);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_531);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_679);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1371);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_629);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_716);
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_640));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetWaveMessage.const_644:
               ...
               break;
            case RoomWidgetDanceMessage.const_511:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_671:
               if(var_8 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_569:
               if(var_8 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_528:
               if(var_8 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_645:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_625)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_251,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_543:
               ...
               if(var_8 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_836:
                        _catalog.openCatalogPage(CatalogPageName.const_1181,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_861:
                        var_8.toggleInventoryPage(InventoryCategory.const_229);
                        break;
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_705:
            case RoomWidgetStopEffectMessage.const_525:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_859:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_993:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_651:
               if(_container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_724:
               ...
               if(var_195 && false)
               {
                  var_195.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_358,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_526:
               ...
               if(_container)
               {
                  ...
                  if(false && _loc23_ == 0)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_449,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_891));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_449,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1250));
                     }
                  }
                  if(false && _container.habboHelp.events)
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_704));
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_531:
            ...
            case RoomWidgetGetSettingsMessage.const_679:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_629:
               _container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_288,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_716:
            ...
            case RoomWidgetAvatarEditorMessage.const_616:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_546));
               }
               break;
            default:
