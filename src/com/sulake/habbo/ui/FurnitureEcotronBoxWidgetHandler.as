package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_698,RoomWidgetEcotronBoxOpenMessage.const_536,RoomWidgetEcotronBoxOpenedMessage.const_1325];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_698:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_536:
