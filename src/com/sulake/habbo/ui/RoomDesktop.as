package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_752:IHabboHelp = null;
      ...
      private var var_751:IRoomWidgetFactory = null;
      ...
      private var var_2163:uint = 16777215;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_591,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_727 = _roomEngine.loadRoomResources(var_38.roomResources);
            if(false)
            {
               var_1325 = false;
         ...
         {
            var_1324 = !_adManager.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_38.roomId,var_38.roomCategory,var_273[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_591,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_17 = null;
         var_751 = null;
         ...
         if(var_195 && false)
         {
            ...
            var_195.events.removeEventListener(HabboToolbarEvent.const_56,onHabboToolbarEvent);
         }
         var_195 = null;
         _localization = null;
         _config = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_2163);
      ...
      public function set layout(param1:XML) : void
      {
         ...
         if(var_195 != null)
         {
            var_177.toolbarSize = var_195.size;
            var_177.toolbarOrientation = var_195.orientation;
         }
      }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_751.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_694:
               ...
               if(var_630 != null && _loc3_ == RoomObjectCategoryEnum.const_33)
               {
                  _loc7_ = var_38.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_412)
                  {
            ...
            case RoomEngineObjectEvent.const_124:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_558,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_703);
            _loc13_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_690);
            _loc14_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_611);
            _loc15_ = _roomEngine.getRoomNumberValue(var_38.roomId,var_38.roomCategory,RoomVariableEnum.const_689);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_405:
               ...
               var_176 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_291,WindowStyle.const_318,WindowParam.const_80) as IToolTipWindow;
               var_176.setParamFlag(WindowParam.const_47,false);
      ...
      {
         if(var_727 == null || false)
         {
            return;
         }
         var _loc2_:int = var_727.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            var_727.splice(_loc2_,1);
         }
         if(false)
         {
            var_1325 = true;
      ...
      {
         if(var_17 != null && var_38 != null && var_1324 && var_1325)
         {
