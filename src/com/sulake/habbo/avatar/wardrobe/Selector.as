package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class Selector
   {
      ...
      public function Selector(param1:HabboAvatarEditor)
      {
         ...
         var_1043 = (_loc3_.content as BitmapData).clone();
         _loc3_ = _assetLibrary.getAssetByName("selectOutfit_over") as BitmapDataAsset;
         var_1284 = (_loc3_.content as BitmapData).clone();
         update(var_1043);
      ...
      private function update(param1:BitmapData) : void
      {
         ...
         var_502.bitmap.copyPixels(param1,param1.rect,new Point(_loc2_,_loc3_));
      }
