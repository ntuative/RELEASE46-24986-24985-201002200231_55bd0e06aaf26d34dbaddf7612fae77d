package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeModel extends CategoryBaseModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_1424:String = "hot_looks";
      
      public static const const_1486:String = "my_looks";
      ...
      public function WardrobeModel(param1:HabboAvatarEditor, param2:String = "")
      {
         ...
         var_935 = param2;
         var_157 = new Array();
         var_599 = new Dictionary();
         var_599["null"] = new Array();
         var_599["null"] = new Array();
         var_599["undefined.index"] = 0;
         var_599["undefined.index"] = 0;
         initMyLooks();
         requestHotLooks();
      }
      ...
      private function onHotLooksConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            for each(_loc5_ in _loc4_.habbo)
            {
               ...
               (var_599[_loc6_.gender] as Array).push(_loc6_);
            }
         }
         else
         {
