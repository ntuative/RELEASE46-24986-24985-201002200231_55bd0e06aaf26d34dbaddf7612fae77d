package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements IAvatarEditorCategoryView
   {
      ...
      private var var_640:IItemListWindow;
      
      private var var_538:IItemListWindow;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_768:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_640 = _window.findChildByName("mylooks") as IItemListWindow;
         var_538 = _window.findChildByName("hotlooks") as IItemListWindow;
         var_768 = _window.findChildByName("selector") as IItemListWindow;
         var_1420 = _window.findChildByName("habboClubNotificationContainer") as IWindowContainer;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "habboClubLink":
                  ...
                  _model.controller.catalog.openCatalogPage(CatalogPageName.const_251,true);
            }
         }
      ...
      private function myLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _model.selectMyLook(var_640.getListItemIndex(param2.parent));
         }
      }
      ...
      private function initSelector() : void
      {
         ...
         {
            var_768.removeListItem(_loc1_.window);
            _loc1_.dispose();
         }
         var_537 = [];
         while(true)
         {
            ...
            var_768.addListItem(_loc1_.window);
      ...
      public function updateHotLooks() : void
      {
         ...
         for each(_loc3_ in _model.hotLooks)
         {
            ...
            {
               var_538.addListItem(_loc3_.view.window);
      ...
      public function updateMyLooks(param1:int) : void
      {
         ...
         else
         {
            ...
            while(false)
            {
               var_640.removeListItemAt(0);
            }
            for each(_loc2_ in _model.myLooks)
            {
               var_640.addListItem(_loc2_.view.window);
      ...
      private function myLooksSelectorEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_768.getListItemIndex(param2);
      ...
      private function hotLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_769 * 8 + var_538.getListItemIndex(param2.parent);
