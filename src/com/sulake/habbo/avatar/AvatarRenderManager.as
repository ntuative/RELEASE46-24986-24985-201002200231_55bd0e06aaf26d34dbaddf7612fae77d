package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_981:PaletteManager;
      
      private var var_653:PetDataManager;
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_292.getValue(AvatarType.const_86) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      private function init() : void
      {
         ...
         var_653 = new PetDataManager(_loc1_,_loc3_);
         var_981 = new PaletteManager(_loc1_,_loc3_);
         var _loc4_:XML = _assets.getAssetByName("HabboAvatarPetFigure").content as XML;
         var_653.populateFigureData(_loc4_);
         ...
         var_292.add(AvatarType.const_86,_loc5_);
      ...
      {
         return var_653 as IPetDataManager;
      }
      
      public function set mode(param1:String) : void
      {
         var_691 = param1;
         if(var_691 == RenderMode.const_1148)
         {
            init();
         }
      }
      ...
      {
         var _loc5_:String = var_653.createAvatarFigureStringNew(param1,param2,param3);
      ...
      {
         var _loc3_:AvatarStructure = var_292.getValue(AvatarType.const_86) as AvatarStructure;
         if(_loc3_ == null)
         {
            return null;
         }
         return new AvatarImage(_loc3_,var_18,param1,param2,AvatarType.const_86);
      }
