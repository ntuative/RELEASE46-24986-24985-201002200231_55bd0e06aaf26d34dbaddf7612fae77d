package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1923 = parseInt(param1.@precedence);
         var_1920 = String(param1.@activepartset);
         var_1925 = String(param1.@assetpartdefinition);
         var_1924 = String(param1.@lay);
         var_1151 = String(param1.@geometrytype);
         var_1921 = Boolean(parseInt(param1.@main));
         var_1922 = Boolean(parseInt(param1.@var_2260));
         var_1918 = Boolean(parseInt(param1.@animation));
         var _loc2_:String = String(param1.@prevents);
         if(_loc2_ != "")
         {
            var_1236 = _loc2_.split(",");
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            var_548.add(param1,new Map());
         }
         var _loc4_:Map = var_548.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = var_548.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      {
         return var_1236.concat(getTypePrevents(param1));
      }
