package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1392:int = 60000;
      ...
      private var var_844:IAvatarImage;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc15_ != null)
            {
               ...
               if(_loc15_.type == AnimationLayerData.const_684)
               {
                  _loc6_ = _loc15_.action;
                  _loc4_ = _loc8_;
               }
               else if(_loc15_.type == AnimationLayerData.const_438)
               {
                  _loc4_ = _loc8_;
               }
               _loc7_ = true;
         ...
         if(_loc14_ == null)
         {
            ...
            _loc10_ = var_69.getParts(param1,(var_844 as AvatarImage).getFigure(),_loc6_,var_1151,_loc4_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_69.getCanvas(var_193,var_1151);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1180[param1])
            {
            ...
            else
            {
               ...
               if((_loc32_ == AvatarAction.const_858 || _loc32_ == AvatarAction.const_506) && (_loc6_ == AvatarBodyPartType.const_308 || _loc6_ == AvatarBodyPartType.const_1185 || _loc6_ == AvatarBodyPartType.const_1262) && _loc7_.color != null)
               {
         ...
         if(_loc20_)
         {
            if(var_193 == AvatarScaleType.const_51)
            {
               _loc30_.x += 67;
            }
            else
