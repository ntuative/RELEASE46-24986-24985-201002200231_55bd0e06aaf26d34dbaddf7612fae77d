package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1056:String = AvatarSetType.const_37;
      
      private static const const_1058:String = "Default";
      
      private static const const_1059:int = 125;
       
      
      private var _avatarSubType:int = 0;
      
      private var var_547:AvatarFigureContainer;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String)
      {
         ...
         if(var_193 == null)
         {
            var_193 = AvatarScaleType.const_51;
         }
         ...
         var_547 = new AvatarFigureContainer(param3);
         if(param5 == AvatarType.PET)
         {
            _loc6_ = var_547.getPartSetId("pbd");
            solvePetAvatarTypeAndRace(_loc6_);
            _avatarSubType = var_985;
         }
         var_122 = new AvatarImageCache(var_69,this,_assets,var_193);
         setDirection(const_1056,const_1057);
         var_192 = new Array();
         resetActions();
      }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         {
            param2 = AvatarDirectionAngle.const_718 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_718)
         {
            param2 -= NaN;
         }
         if(var_685 == AvatarType.PET && param1 == AvatarSetType.const_46)
         {
      ...
      private function sortActions() : void
      {
         ...
         resetActions();
         _isAnimating = false;
         var _loc1_:Array = var_69.sortActions(var_192);
         if(_loc1_ == null)
         {
         ...
         {
            var_548 = var_69.getCanvasOffsets(_loc1_,var_193,var_92);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc2_.definition.isAnimation)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_1198 = _loc3_.directionData.offset;
                  }
            ...
            if(_loc2_.actionType == AvatarAction.const_423)
            {
               _isAnimating = true;
            }
         }
      ...
      {
         return var_69.getPartColor(var_547,param1);
      }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_69.getCanvas(var_193,var_166.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = var_69.getBodyParts(param1,var_166.definition,var_92);
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               if(var_685 == AvatarType.PET)
               {
                  _loc14_ = getCache().getBodyPartCache(_loc9_);
                  _loc15_ = _loc14_.getAction();
                  _loc16_ = _loc15_.definition.assetPartDefinition;
                  _loc17_ = var_69.getParts(_loc9_,var_547,_loc15_,"pet",_loc14_.getDirection());
                  _loc18_ = 32;
                  if(var_193 == AvatarScaleType.const_96)
                  {
                     _loc18_ = 6;
                  }
                  if(_loc17_.length > 0)
                  {
                     ...
                     _loc23_ = var_69.getPartActionOffset(getSubType(),var_193,_loc9_,_loc16_,_loc20_,_loc21_);
                     if(_loc23_ != null)
                     {
      ...
      public function getImage(param1:String) : BitmapData
      {
         ...
         {
            _loc3_ = var_69.getCanvas(var_193,var_166.definition.geometryType);
            if(_loc3_ == null)
            {
               return null;
            }
         ...
         var _loc4_:Array = var_69.getBodyParts(param1,var_166.definition,var_92);
         _image.lock();
         ...
         while(_loc6_ >= 0)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(var_685 == AvatarType.PET)
               {
                  ...
                  _loc14_ = var_69.getParts(_loc7_,var_547,_loc12_,"pet",_loc11_.getDirection());
                  ...
                  if(_loc14_.length > 0)
                  {
                     ...
                     _loc21_ = var_69.getPartActionOffset(getSubType(),var_193,_loc7_,_loc13_,_loc18_,_loc19_);
                     if(_loc21_ != null)
                     {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_166 = new ActiveActionData(AvatarAction.const_878);
         var_166.definition = var_69.getActionDefinition(const_1058);
      ...
      {
         return var_69.getBodyPartData(param1.animation.id,var_464,param1.id);
      }
