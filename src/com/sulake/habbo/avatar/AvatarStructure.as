package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_411:PartSetsData;
      
      private var var_1953:PartOffsetData;
      
      private var var_827:AvatarActionManager;
      
      private var var_152:IAssetLibrary;
      
      private var var_2302:IAssetLibrary;
      
      private var var_1369:Boolean = false;
      
      private var var_1954:AvatarRenderManager;
      
      private var var_484:FigureData;
      ...
      private var var_1490:AvatarStructureDownloadSet;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_152 = param2;
         var_2302 = param3;
         var_484 = new FigureData();
         var_411 = new PartSetsData();
         _animationData = new AnimationData();
         var_1490 = new AvatarStructureDownloadSet();
         var_686 = new AnimationManager();
         var_685 = param4;
         var_1953 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_827.getActionDefinitionWithState(param1);
      }
      ...
      private function init() : void
      {
         ...
         switch(var_685)
         {
            case AvatarType.const_86:
               _loc1_ = var_152.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_411.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_152.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_152.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_484.parse(_loc3_))
               {
                  return;
               }
               break;
            case AvatarType.PET:
               _loc1_ = var_152.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_411.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_152.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_152.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_484.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_827.getCanvasOffsets(param1,param2,param3);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_827.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_411.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_411.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1358[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_827.getDefaultActionType();
         var _loc7_:Array = var_411.getActiveParts(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_686.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_484.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_484.getPalette(_loc23_.paletteID);
               if(_loc24_)
               {
                  ...
                  if(_loc25_ != null)
                  {
                     ...
                     for each(_loc26_ in _loc25_.parts)
                     {
                        if(_loc9_.indexOf(_loc26_.type) > -1)
                        {
                           ...
                           _loc13_ = var_411.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc35_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_411.getPartDefinition(_loc11_);
                     _loc37_ = false;
                     _loc38_ = 1;
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_86:
               if(var_152.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_152.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_152.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_152.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_685 + " ready to go!");
         if(var_685 == AvatarType.const_86)
         {
            var_411.getPartDefinition("ri").appendToFigure = true;
            var_411.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_86:
               var_1490.add(new AvatarStructureDownload(var_152,_loc5_,var_484));
               break;
            case AvatarType.PET:
         }
         var_1490.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      ...
      {
         var_827 = new AvatarActionManager(var_152,var_685);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_152.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_152.getAssetByName("dance" + _loc1_).content as XML;
            var_686.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_152.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_152.getAssetByName("fx" + _loc1_).content as XML;
            var_686.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         return var_1953.getOffset(param1,param2,param3,param4,param5,param6);
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_484.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_484.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return var_827.sortActions(param1);
      }
   }
}
