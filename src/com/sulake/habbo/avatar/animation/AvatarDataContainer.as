package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1576:Number = 1;
      
      private var _b:uint;
      
      private var var_1575:Number = 1;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1577,var_1575,var_1576,_alphaMultiplier);
         var_1080 = generatePaletteMapForGrayscale(var_2223,var_2224);
      }
      
      public function get reds() : Array
      {
         return var_1080.getValue("reds") as Array;
      }
      ...
      {
         return var_1080.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1080.getValue("greens") as Array;
      }
      ...
      {
         return var_1080.getValue("alphas") as Array;
      }
