package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      private var var_1548:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog)
      {
         ...
         if(var_1584 == null)
         {
            ...
            var_1584 = var_11.windowManager.buildFromXML(_loc5_.content as XML) as IWindowContainer;
         }
      ...
      private function createWindow() : void
      {
         ...
         var_1548 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_658 != null)
         {
            toggleCategoryView(var_658,true);
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_658 = param1;
         var_1548.setSelected(var_1548.getSelectableByName(param1));
         _window.invalidate();
      }
